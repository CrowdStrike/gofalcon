 ...
 * [simple](simple/) - minimal example that authenticates to Falcon platform and lists registered hosts
 ...
 * [falcon_rtr_admin_put_file](falcon_rtr_admin_put_file) - stand-alone example of uploading a file and putting it in a specific directory on an agent using RTR (Real-Time Response) API
...
```
go install github.com/crowdstrike/gofalcon/examples/...@latest
```
