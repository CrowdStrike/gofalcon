...
func (m *APIValidationRequestV1) validateFields(formats strfmt.Registry) error {
...
func (m *APIValidationRequestV1) contextValidateFields(ctx context.Context, formats strfmt.Registry) error {
...
func (m *APIValidationRequestV1) UnmarshalBinary(b []byte) error {
	var res APIValidationRequestV1
...
// String returns the JSON body of this api validation request v1. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *APIValidationRequestV1) String() string {
	if m == nil {
		return "<nil>"
	}
