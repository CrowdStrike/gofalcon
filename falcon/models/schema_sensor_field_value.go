...
func (m *SchemaSensorFieldValue) validateDescription(formats strfmt.Registry) error {
...
func (m *SchemaSensorFieldValue) validateName(formats strfmt.Registry) error {
...
func (m *SchemaSensorFieldValue) validateValue(formats strfmt.Registry) error {
...
func (m *SchemaSensorFieldValue) UnmarshalBinary(b []byte) error {
	var res SchemaSensorFieldValue
...
// String returns the JSON body of this schema sensor field value. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *SchemaSensorFieldValue) String() string {
	if m == nil {
		return "<nil>"
	}
