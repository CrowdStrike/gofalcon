...
// String returns the JSON body of this domain API aggregate compliance by cluster type v1. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *DomainAPIAggregateComplianceByClusterTypeV1) String() string {
	if m == nil {
		return "<nil>"
	}
