...
// String returns the JSON body of this domain s p API combined vulnerabilities response. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *DomainSPAPICombinedVulnerabilitiesResponse) String() string {
	if m == nil {
		return "<nil>"
	}
