...
// String returns the JSON body of this itautomation create scheduled task request. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *ItautomationCreateScheduledTaskRequest) String() string {
	if m == nil {
		return "<nil>"
	}
