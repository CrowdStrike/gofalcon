...
func (m *AlertsContainerAlertsCountValue) validateMeta(formats strfmt.Registry) error {
...
func (m *AlertsContainerAlertsCountValue) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AlertsContainerAlertsCountValue) UnmarshalBinary(b []byte) error {
	var res AlertsContainerAlertsCountValue
...
// String returns the JSON body of this alerts container alerts count value. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *AlertsContainerAlertsCountValue) String() string {
	if m == nil {
		return "<nil>"
	}
