...
func (m *APIIndicatorsQueryPaging) validateLimit(formats strfmt.Registry) error {
...
func (m *APIIndicatorsQueryPaging) validateTotal(formats strfmt.Registry) error {
...
func (m *APIIndicatorsQueryPaging) UnmarshalBinary(b []byte) error {
	var res APIIndicatorsQueryPaging
...
// String returns the JSON body of this api indicators query paging. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *APIIndicatorsQueryPaging) String() string {
	if m == nil {
		return "<nil>"
	}
