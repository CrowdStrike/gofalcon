...
func (m *MsaspecIdsRequest) validateIds(formats strfmt.Registry) error {
...
// String returns the JSON body of this msaspec ids request. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *MsaspecIdsRequest) String() string {
	if m == nil {
		return "<nil>"
	}
