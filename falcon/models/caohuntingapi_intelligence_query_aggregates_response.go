...
// String returns the JSON body of this caohuntingapi intelligence query aggregates response. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *CaohuntingapiIntelligenceQueryAggregatesResponse) String() string {
	if m == nil {
		return "<nil>"
	}
