...
// String returns the JSON body of this registration a w s account create request ext v2. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *RegistrationAWSAccountCreateRequestExtV2) String() string {
	if m == nil {
		return "<nil>"
	}
