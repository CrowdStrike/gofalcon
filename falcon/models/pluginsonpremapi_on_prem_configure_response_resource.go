...
// String returns the JSON body of this pluginsonpremapi on prem configure response resource. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *PluginsonpremapiOnPremConfigureResponseResource) String() string {
	if m == nil {
		return "<nil>"
	}
