...
// Validate validates this csdomain action parameter
...
func (m *CsdomainActionParameter) validateName(formats strfmt.Registry) error {
...
func (m *CsdomainActionParameter) validateValue(formats strfmt.Registry) error {
...
func (m *CsdomainActionParameter) UnmarshalBinary(b []byte) error {
	var res CsdomainActionParameter
