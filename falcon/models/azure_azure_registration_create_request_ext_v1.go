...
// String returns the JSON body of this azure azure registration create request ext v1. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *AzureAzureRegistrationCreateRequestExtV1) String() string {
	if m == nil {
		return "<nil>"
	}
