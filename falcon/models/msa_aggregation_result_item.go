...
func (m *MsaAggregationResultItem) validateCount(formats strfmt.Registry) error {
...
func (m *MsaAggregationResultItem) UnmarshalBinary(b []byte) error {
	var res MsaAggregationResultItem
...
// String returns the JSON body of this msa aggregation result item. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *MsaAggregationResultItem) String() string {
	if m == nil {
		return "<nil>"
	}
