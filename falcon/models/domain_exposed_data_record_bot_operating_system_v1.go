...
// String returns the JSON body of this domain exposed data record bot operating system v1. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *DomainExposedDataRecordBotOperatingSystemV1) String() string {
	if m == nil {
		return "<nil>"
	}
