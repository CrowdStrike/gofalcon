...
func (m *MessagesAlert) validateID(formats strfmt.Registry) error {
...
func (m *MessagesAlert) validateProduct(formats strfmt.Registry) error {
...
func (m *MessagesAlert) validateURL(formats strfmt.Registry) error {
...
// String returns the JSON body of this messages alert. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *MessagesAlert) String() string {
	if m == nil {
		return "<nil>"
	}
