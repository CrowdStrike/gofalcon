...
// String returns the JSON body of this domain multi command execute response wrapper. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *DomainMultiCommandExecuteResponseWrapper) String() string {
	if m == nil {
		return "<nil>"
	}
