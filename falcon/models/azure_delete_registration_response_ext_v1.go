...
type AzureDeleteRegistrationResponseExtV1 struct {
	...
	// resources
	// Required: true
	Resources []*AzureDeletedRegistration `json:"resources"`
}
...
// String returns the JSON body of this azure delete registration response ext v1. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *AzureDeleteRegistrationResponseExtV1) String() string {
	if m == nil {
		return "<nil>"
	}
