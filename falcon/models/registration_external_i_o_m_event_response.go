...
// String returns the JSON body of this registration external i o m event response. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *RegistrationExternalIOMEventResponse) String() string {
	if m == nil {
		return "<nil>"
	}
