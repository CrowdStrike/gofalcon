...
func (m *RemoteResponseUpdatePolicyReqV1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *RemoteResponseUpdatePolicyReqV1) validateID(formats strfmt.Registry) error {
...
func (m *RemoteResponseUpdatePolicyReqV1) validateSettings(formats strfmt.Registry) error {
...
func (m *RemoteResponseUpdatePolicyReqV1) contextValidateSettings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RemoteResponseUpdatePolicyReqV1) UnmarshalBinary(b []byte) error {
	var res RemoteResponseUpdatePolicyReqV1
...
// String returns the JSON body of this remote response update policy req v1. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *RemoteResponseUpdatePolicyReqV1) String() string {
	if m == nil {
		return "<nil>"
	}
