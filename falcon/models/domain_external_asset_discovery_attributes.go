...
// String returns the JSON body of this domain external asset discovery attributes. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *DomainExternalAssetDiscoveryAttributes) String() string {
	if m == nil {
		return "<nil>"
	}
