...
// String returns the JSON body of this models compliance export grouped by rules report. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *ModelsComplianceExportGroupedByRulesReport) String() string {
	if m == nil {
		return "<nil>"
	}
