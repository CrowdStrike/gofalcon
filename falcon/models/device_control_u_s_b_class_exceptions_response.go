...
// String returns the JSON body of this device control u s b class exceptions response. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *DeviceControlUSBClassExceptionsResponse) String() string {
	if m == nil {
		return "<nil>"
	}
