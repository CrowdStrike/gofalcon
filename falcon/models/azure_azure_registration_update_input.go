...
// AzureAzureRegistrationUpdateInput azure azure registration update input
//
// swagger:model azure.AzureRegistrationUpdateInput
type AzureAzureRegistrationUpdateInput struct {
...
func (m *AzureAzureRegistrationUpdateInput) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *AzureAzureRegistrationUpdateInput) validateAdditionalFeatures(formats strfmt.Registry) error {
...
func (m *AzureAzureRegistrationUpdateInput) validateDspmCustomVnetConfiguration(formats strfmt.Registry) error {
...
var azureAzureRegistrationUpdateInputTypeDspmNetworkConfigurationTypePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		azureAzureRegistrationUpdateInputTypeDspmNetworkConfigurationTypePropEnum = append(azureAzureRegistrationUpdateInputTypeDspmNetworkConfigurationTypePropEnum, v)
	}
}

const (

	// AzureAzureRegistrationUpdateInputDspmNetworkConfigurationTypeManaged captures enum value "managed"
	AzureAzureRegistrationUpdateInputDspmNetworkConfigurationTypeManaged string = "managed"

	// AzureAzureRegistrationUpdateInputDspmNetworkConfigurationTypeManagedNoNat captures enum value "managed_no_nat"
	AzureAzureRegistrationUpdateInputDspmNetworkConfigurationTypeManagedNoNat string = "managed_no_nat"

	// AzureAzureRegistrationUpdateInputDspmNetworkConfigurationTypeCustom captures enum value "custom"
	AzureAzureRegistrationUpdateInputDspmNetworkConfigurationTypeCustom string = "custom"
)

// prop value enum
func (m *AzureAzureRegistrationUpdateInput) validateDspmNetworkConfigurationTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, azureAzureRegistrationUpdateInputTypeDspmNetworkConfigurationTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *AzureAzureRegistrationUpdateInput) validateDspmNetworkConfigurationType(formats strfmt.Registry) error {
...
func (m *AzureAzureRegistrationUpdateInput) validateEventHubSettings(formats strfmt.Registry) error {
...
func (m *AzureAzureRegistrationUpdateInput) validateManagementGroupIds(formats strfmt.Registry) error {
...
func (m *AzureAzureRegistrationUpdateInput) validateProducts(formats strfmt.Registry) error {
...
func (m *AzureAzureRegistrationUpdateInput) validateSubscriptionIds(formats strfmt.Registry) error {
...
func (m *AzureAzureRegistrationUpdateInput) validateTags(formats strfmt.Registry) error {
...
func (m *AzureAzureRegistrationUpdateInput) validateVulnerabilityScanningCustomVnetConfiguration(formats strfmt.Registry) error {
...
var azureAzureRegistrationUpdateInputTypeVulnerabilityScanningNetworkConfigurationTypePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		azureAzureRegistrationUpdateInputTypeVulnerabilityScanningNetworkConfigurationTypePropEnum = append(azureAzureRegistrationUpdateInputTypeVulnerabilityScanningNetworkConfigurationTypePropEnum, v)
	}
}

const (

	// AzureAzureRegistrationUpdateInputVulnerabilityScanningNetworkConfigurationTypeManaged captures enum value "managed"
	AzureAzureRegistrationUpdateInputVulnerabilityScanningNetworkConfigurationTypeManaged string = "managed"

	// AzureAzureRegistrationUpdateInputVulnerabilityScanningNetworkConfigurationTypeManagedNoNat captures enum value "managed_no_nat"
	AzureAzureRegistrationUpdateInputVulnerabilityScanningNetworkConfigurationTypeManagedNoNat string = "managed_no_nat"

	// AzureAzureRegistrationUpdateInputVulnerabilityScanningNetworkConfigurationTypeCustom captures enum value "custom"
	AzureAzureRegistrationUpdateInputVulnerabilityScanningNetworkConfigurationTypeCustom string = "custom"
)

// prop value enum
func (m *AzureAzureRegistrationUpdateInput) validateVulnerabilityScanningNetworkConfigurationTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, azureAzureRegistrationUpdateInputTypeVulnerabilityScanningNetworkConfigurationTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *AzureAzureRegistrationUpdateInput) validateVulnerabilityScanningNetworkConfigurationType(formats strfmt.Registry) error {
...
func (m *AzureAzureRegistrationUpdateInput) validateVulnerabilityScanningRegions(formats strfmt.Registry) error {
...
// ContextValidate validate this azure azure registration update input based on the context it is used
func (m *AzureAzureRegistrationUpdateInput) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *AzureAzureRegistrationUpdateInput) contextValidateAdditionalFeatures(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AzureAzureRegistrationUpdateInput) contextValidateDspmCustomVnetConfiguration(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AzureAzureRegistrationUpdateInput) contextValidateEventHubSettings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AzureAzureRegistrationUpdateInput) contextValidateProducts(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AzureAzureRegistrationUpdateInput) contextValidateVulnerabilityScanningCustomVnetConfiguration(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AzureAzureRegistrationUpdateInput) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *AzureAzureRegistrationUpdateInput) UnmarshalBinary(b []byte) error {
	var res AzureAzureRegistrationUpdateInput
...
// String returns the JSON body of this azure azure registration update input. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *AzureAzureRegistrationUpdateInput) String() string {
	if m == nil {
		return "<nil>"
	}
