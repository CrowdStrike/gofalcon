...
func (m *DetectionsAPIDetectionsCount) validateMeta(formats strfmt.Registry) error {
...
func (m *DetectionsAPIDetectionsCount) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DetectionsAPIDetectionsCount) UnmarshalBinary(b []byte) error {
	var res DetectionsAPIDetectionsCount
...
// String returns the JSON body of this detections api detections count. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *DetectionsAPIDetectionsCount) String() string {
	if m == nil {
		return "<nil>"
	}
