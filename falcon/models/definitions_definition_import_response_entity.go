...
// String returns the JSON body of this definitions definition import response entity. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *DefinitionsDefinitionImportResponseEntity) String() string {
	if m == nil {
		return "<nil>"
	}
