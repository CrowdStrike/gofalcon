...
func (m *RequestsIoaExclusionCreateReqV1) validateClRegex(formats strfmt.Registry) error {
...
func (m *RequestsIoaExclusionCreateReqV1) validateDescription(formats strfmt.Registry) error {
...
func (m *RequestsIoaExclusionCreateReqV1) validateDetectionJSON(formats strfmt.Registry) error {
...
func (m *RequestsIoaExclusionCreateReqV1) validateGroups(formats strfmt.Registry) error {
...
func (m *RequestsIoaExclusionCreateReqV1) validateIfnRegex(formats strfmt.Registry) error {
...
func (m *RequestsIoaExclusionCreateReqV1) validateName(formats strfmt.Registry) error {
...
func (m *RequestsIoaExclusionCreateReqV1) validatePatternID(formats strfmt.Registry) error {
...
func (m *RequestsIoaExclusionCreateReqV1) validatePatternName(formats strfmt.Registry) error {
...
func (m *RequestsIoaExclusionCreateReqV1) UnmarshalBinary(b []byte) error {
	var res RequestsIoaExclusionCreateReqV1
