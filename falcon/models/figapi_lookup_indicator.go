...
func (m *FigapiLookupIndicator) validateRootDomainDetails(formats strfmt.Registry) error {
...
func (m *FigapiLookupIndicator) contextValidateRootDomainDetails(ctx context.Context, formats strfmt.Registry) error {
