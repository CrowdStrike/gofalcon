...
// String returns the JSON body of this deviceapi update device details response v1. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *DeviceapiUpdateDeviceDetailsResponseV1) String() string {
	if m == nil {
		return "<nil>"
	}
