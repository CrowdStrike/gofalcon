...
func (m *PreventionUpdatePoliciesReqV1) validateResources(formats strfmt.Registry) error {
...
func (m *PreventionUpdatePoliciesReqV1) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PreventionUpdatePoliciesReqV1) UnmarshalBinary(b []byte) error {
	var res PreventionUpdatePoliciesReqV1
...
// String returns the JSON body of this prevention update policies req v1. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *PreventionUpdatePoliciesReqV1) String() string {
	if m == nil {
		return "<nil>"
	}
