...
func (m *Day) validateLiveCost(formats strfmt.Registry) error {
...
func (m *Day) validateQueryCount(formats strfmt.Registry) error {
...
func (m *Day) validateStaticCost(formats strfmt.Registry) error {
...
// String returns the JSON body of this day. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *Day) String() string {
	if m == nil {
		return "<nil>"
	}
