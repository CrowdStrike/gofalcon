...
// String returns the JSON body of this devicecontrolapi bluetooth exception base. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *DevicecontrolapiBluetoothExceptionBase) String() string {
	if m == nil {
		return "<nil>"
	}
