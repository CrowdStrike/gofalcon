...
func (m *DriftindicatorsDriftIndicatorsCountValue) validateMeta(formats strfmt.Registry) error {
...
func (m *DriftindicatorsDriftIndicatorsCountValue) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DriftindicatorsDriftIndicatorsCountValue) UnmarshalBinary(b []byte) error {
	var res DriftindicatorsDriftIndicatorsCountValue
...
// String returns the JSON body of this driftindicators drift indicators count value. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *DriftindicatorsDriftIndicatorsCountValue) String() string {
	if m == nil {
		return "<nil>"
	}
