...
func (m *DomainUserGroupsRequestV1) validateResources(formats strfmt.Registry) error {
...
func (m *DomainUserGroupsRequestV1) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DomainUserGroupsRequestV1) UnmarshalBinary(b []byte) error {
	var res DomainUserGroupsRequestV1
...
// String returns the JSON body of this domain user groups request v1. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *DomainUserGroupsRequestV1) String() string {
	if m == nil {
		return "<nil>"
	}
