...
func (m *K8siomsKubernetesIOMFieldValue) validateMeta(formats strfmt.Registry) error {
...
func (m *K8siomsKubernetesIOMFieldValue) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *K8siomsKubernetesIOMFieldValue) UnmarshalBinary(b []byte) error {
	var res K8siomsKubernetesIOMFieldValue
...
// String returns the JSON body of this k8sioms kubernetes i o m field value. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *K8siomsKubernetesIOMFieldValue) String() string {
	if m == nil {
		return "<nil>"
	}
