...
// String returns the JSON body of this detectsapi post entities alerts v2 request. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *DetectsapiPostEntitiesAlertsV2Request) String() string {
	if m == nil {
		return "<nil>"
	}
