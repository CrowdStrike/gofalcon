...
func (m *RegistrationAzureAccountCreateRequestExternalV1) validateResources(formats strfmt.Registry) error {
...
func (m *RegistrationAzureAccountCreateRequestExternalV1) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RegistrationAzureAccountCreateRequestExternalV1) UnmarshalBinary(b []byte) error {
	var res RegistrationAzureAccountCreateRequestExternalV1
...
// String returns the JSON body of this registration azure account create request external v1. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *RegistrationAzureAccountCreateRequestExternalV1) String() string {
	if m == nil {
		return "<nil>"
	}
