...
// String returns the JSON body of this api parser test case assertions for output. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *APIParserTestCaseAssertionsForOutput) String() string {
	if m == nil {
		return "<nil>"
	}
