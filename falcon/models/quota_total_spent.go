...
// QuotaTotalSpent quota total spent
//
// swagger:model .quotaTotalSpent
type QuotaTotalSpent struct {
...
// Validate validates this quota total spent
func (m *QuotaTotalSpent) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *QuotaTotalSpent) validateDay(formats strfmt.Registry) error {
...
func (m *QuotaTotalSpent) validateHour(formats strfmt.Registry) error {
...
func (m *QuotaTotalSpent) validateOneMinute(formats strfmt.Registry) error {
...
func (m *QuotaTotalSpent) validateTenMinutes(formats strfmt.Registry) error {
...
// ContextValidate validate this quota total spent based on the context it is used
func (m *QuotaTotalSpent) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *QuotaTotalSpent) contextValidateDay(ctx context.Context, formats strfmt.Registry) error {
...
func (m *QuotaTotalSpent) contextValidateHour(ctx context.Context, formats strfmt.Registry) error {
...
func (m *QuotaTotalSpent) contextValidateOneMinute(ctx context.Context, formats strfmt.Registry) error {
...
func (m *QuotaTotalSpent) contextValidateTenMinutes(ctx context.Context, formats strfmt.Registry) error {
...
func (m *QuotaTotalSpent) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *QuotaTotalSpent) UnmarshalBinary(b []byte) error {
	var res QuotaTotalSpent
...
// String returns the JSON body of this quota total spent. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *QuotaTotalSpent) String() string {
	if m == nil {
		return "<nil>"
	}
