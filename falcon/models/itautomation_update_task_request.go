...
var itautomationUpdateTaskRequestTypeAccessTypePropEnum []interface{}
...
var itautomationUpdateTaskRequestTypeTaskTypePropEnum []interface{}
...
// String returns the JSON body of this itautomation update task request. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *ItautomationUpdateTaskRequest) String() string {
	if m == nil {
		return "<nil>"
	}
