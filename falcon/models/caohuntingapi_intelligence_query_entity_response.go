...
// String returns the JSON body of this caohuntingapi intelligence query entity response. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *CaohuntingapiIntelligenceQueryEntityResponse) String() string {
	if m == nil {
		return "<nil>"
	}
