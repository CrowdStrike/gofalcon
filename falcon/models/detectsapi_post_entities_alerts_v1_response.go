...
// String returns the JSON body of this detectsapi post entities alerts v1 response. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *DetectsapiPostEntitiesAlertsV1Response) String() string {
	if m == nil {
		return "<nil>"
	}
