...
// String returns the JSON body of this devicecontrolapi req update bluetooth base v1. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *DevicecontrolapiReqUpdateBluetoothBaseV1) String() string {
	if m == nil {
		return "<nil>"
	}
