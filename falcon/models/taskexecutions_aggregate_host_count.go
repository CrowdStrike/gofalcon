...
// TaskexecutionsAggregateHostCount taskexecutions aggregate host count
//
// swagger:model taskexecutions.AggregateHostCount
type TaskexecutionsAggregateHostCount struct {
...
// Validate validates this taskexecutions aggregate host count
func (m *TaskexecutionsAggregateHostCount) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *TaskexecutionsAggregateHostCount) validateCanceledHostCount(formats strfmt.Registry) error {
...
func (m *TaskexecutionsAggregateHostCount) validateExpiredHostCount(formats strfmt.Registry) error {
...
func (m *TaskexecutionsAggregateHostCount) validateFailedHostCount(formats strfmt.Registry) error {
...
func (m *TaskexecutionsAggregateHostCount) validateInitiatedHostCount(formats strfmt.Registry) error {
...
func (m *TaskexecutionsAggregateHostCount) validateOfflineHostCount(formats strfmt.Registry) error {
...
func (m *TaskexecutionsAggregateHostCount) validateQueuedHostCount(formats strfmt.Registry) error {
...
func (m *TaskexecutionsAggregateHostCount) validateRunningHostCount(formats strfmt.Registry) error {
...
func (m *TaskexecutionsAggregateHostCount) validateSuccessHostCount(formats strfmt.Registry) error {
...
// ContextValidate validates this taskexecutions aggregate host count based on context it is used
func (m *TaskexecutionsAggregateHostCount) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *TaskexecutionsAggregateHostCount) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *TaskexecutionsAggregateHostCount) UnmarshalBinary(b []byte) error {
	var res TaskexecutionsAggregateHostCount
