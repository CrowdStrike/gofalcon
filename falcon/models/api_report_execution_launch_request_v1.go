...
func (m *APIReportExecutionLaunchRequestV1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *APIReportExecutionLaunchRequestV1) validateID(formats strfmt.Registry) error {
...
func (m *APIReportExecutionLaunchRequestV1) UnmarshalBinary(b []byte) error {
	var res APIReportExecutionLaunchRequestV1
