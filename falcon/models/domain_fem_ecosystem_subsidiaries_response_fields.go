...
// String returns the JSON body of this domain fem ecosystem subsidiaries response fields. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *DomainFemEcosystemSubsidiariesResponseFields) String() string {
	if m == nil {
		return "<nil>"
	}
