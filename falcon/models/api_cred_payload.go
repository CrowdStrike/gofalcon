...
func (m *APICredPayload) validateDetails(formats strfmt.Registry) error {
...
func (m *APICredPayload) validateType(formats strfmt.Registry) error {
...
// String returns the JSON body of this api cred payload. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *APICredPayload) String() string {
	if m == nil {
		return "<nil>"
	}
