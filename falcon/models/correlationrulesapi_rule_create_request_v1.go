...
// CorrelationrulesapiRuleCreateRequestV1 correlationrulesapi rule create request v1
//
...
// Validate validates this correlationrulesapi rule create request v1
...
func (m *CorrelationrulesapiRuleCreateRequestV1) validateCustomerID(formats strfmt.Registry) error {
...
func (m *CorrelationrulesapiRuleCreateRequestV1) validateGuardrailNotifications(formats strfmt.Registry) error {
...
func (m *CorrelationrulesapiRuleCreateRequestV1) validateMitreAttack(formats strfmt.Registry) error {
...
func (m *CorrelationrulesapiRuleCreateRequestV1) validateName(formats strfmt.Registry) error {
...
func (m *CorrelationrulesapiRuleCreateRequestV1) validateNotifications(formats strfmt.Registry) error {
...
func (m *CorrelationrulesapiRuleCreateRequestV1) validateOperation(formats strfmt.Registry) error {
...
func (m *CorrelationrulesapiRuleCreateRequestV1) validateSearch(formats strfmt.Registry) error {
...
func (m *CorrelationrulesapiRuleCreateRequestV1) validateSeverity(formats strfmt.Registry) error {
...
func (m *CorrelationrulesapiRuleCreateRequestV1) validateStatus(formats strfmt.Registry) error {
...
func (m *CorrelationrulesapiRuleCreateRequestV1) validateTemplateID(formats strfmt.Registry) error {
...
// ContextValidate validate this correlationrulesapi rule create request v1 based on the context it is used
...
func (m *CorrelationrulesapiRuleCreateRequestV1) contextValidateGuardrailNotifications(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CorrelationrulesapiRuleCreateRequestV1) contextValidateMitreAttack(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CorrelationrulesapiRuleCreateRequestV1) contextValidateNotifications(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CorrelationrulesapiRuleCreateRequestV1) contextValidateOperation(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CorrelationrulesapiRuleCreateRequestV1) contextValidateSearch(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CorrelationrulesapiRuleCreateRequestV1) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CorrelationrulesapiRuleCreateRequestV1) UnmarshalBinary(b []byte) error {
	var res CorrelationrulesapiRuleCreateRequestV1
...
// String returns the JSON body of this correlationrulesapi rule create request v1. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *CorrelationrulesapiRuleCreateRequestV1) String() string {
	if m == nil {
		return "<nil>"
	}
