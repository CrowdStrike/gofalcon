...
func (m *HostGroupsUpdateGroupsReqV1) validateResources(formats strfmt.Registry) error {
...
func (m *HostGroupsUpdateGroupsReqV1) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HostGroupsUpdateGroupsReqV1) UnmarshalBinary(b []byte) error {
	var res HostGroupsUpdateGroupsReqV1
...
// String returns the JSON body of this host groups update groups req v1. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *HostGroupsUpdateGroupsReqV1) String() string {
	if m == nil {
		return "<nil>"
	}
