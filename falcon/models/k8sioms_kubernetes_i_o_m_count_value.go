...
func (m *K8siomsKubernetesIOMCountValue) validateMeta(formats strfmt.Registry) error {
...
func (m *K8siomsKubernetesIOMCountValue) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *K8siomsKubernetesIOMCountValue) UnmarshalBinary(b []byte) error {
	var res K8siomsKubernetesIOMCountValue
...
// String returns the JSON body of this k8sioms kubernetes i o m count value. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *K8siomsKubernetesIOMCountValue) String() string {
	if m == nil {
		return "<nil>"
	}
