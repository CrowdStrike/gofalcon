...
func (m *DetectsapiAggregatesResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *DetectsapiAggregatesResponse) validateMeta(formats strfmt.Registry) error {
...
func (m *DetectsapiAggregatesResponse) validateResources(formats strfmt.Registry) error {
...
func (m *DetectsapiAggregatesResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DetectsapiAggregatesResponse) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DetectsapiAggregatesResponse) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DetectsapiAggregatesResponse) UnmarshalBinary(b []byte) error {
	var res DetectsapiAggregatesResponse
...
// String returns the JSON body of this detectsapi aggregates response. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *DetectsapiAggregatesResponse) String() string {
	if m == nil {
		return "<nil>"
	}
