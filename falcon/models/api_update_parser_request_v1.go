...
// APIUpdateParserRequestV1 api update parser request v1
//
// swagger:model api.UpdateParserRequestV1
type APIUpdateParserRequestV1 struct {
...
// Validate validates this api update parser request v1
func (m *APIUpdateParserRequestV1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *APIUpdateParserRequestV1) validateFieldsToBeRemovedBeforeParsing(formats strfmt.Registry) error {
...
func (m *APIUpdateParserRequestV1) validateFieldsToTag(formats strfmt.Registry) error {
...
func (m *APIUpdateParserRequestV1) validateID(formats strfmt.Registry) error {
...
func (m *APIUpdateParserRequestV1) validateRepository(formats strfmt.Registry) error {
...
func (m *APIUpdateParserRequestV1) validateScript(formats strfmt.Registry) error {
...
func (m *APIUpdateParserRequestV1) validateTestCases(formats strfmt.Registry) error {
...
// ContextValidate validate this api update parser request v1 based on the context it is used
func (m *APIUpdateParserRequestV1) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *APIUpdateParserRequestV1) contextValidateTestCases(ctx context.Context, formats strfmt.Registry) error {
...
func (m *APIUpdateParserRequestV1) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *APIUpdateParserRequestV1) UnmarshalBinary(b []byte) error {
	var res APIUpdateParserRequestV1
...
// String returns the JSON body of this api update parser request v1. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *APIUpdateParserRequestV1) String() string {
	if m == nil {
		return "<nil>"
	}
