...
// String returns the JSON body of this client system definition de provision request. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *ClientSystemDefinitionDeProvisionRequest) String() string {
	if m == nil {
		return "<nil>"
	}
