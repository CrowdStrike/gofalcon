...
func (m *FwmgrFirewallMonitoring) validateCount(formats strfmt.Registry) error {
...
func (m *FwmgrFirewallMonitoring) validatePeriodMs(formats strfmt.Registry) error {
...
func (m *FwmgrFirewallMonitoring) UnmarshalBinary(b []byte) error {
	var res FwmgrFirewallMonitoring
...
// String returns the JSON body of this fwmgr firewall monitoring. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *FwmgrFirewallMonitoring) String() string {
	if m == nil {
		return "<nil>"
	}
