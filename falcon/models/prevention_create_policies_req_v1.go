...
func (m *PreventionCreatePoliciesReqV1) validateResources(formats strfmt.Registry) error {
...
func (m *PreventionCreatePoliciesReqV1) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PreventionCreatePoliciesReqV1) UnmarshalBinary(b []byte) error {
	var res PreventionCreatePoliciesReqV1
...
// String returns the JSON body of this prevention create policies req v1. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *PreventionCreatePoliciesReqV1) String() string {
	if m == nil {
		return "<nil>"
	}
