...
func (m *DomainRegisterActionsRequest) validateActions(formats strfmt.Registry) error {
...
func (m *DomainRegisterActionsRequest) validateRuleID(formats strfmt.Registry) error {
...
func (m *DomainRegisterActionsRequest) contextValidateActions(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DomainRegisterActionsRequest) UnmarshalBinary(b []byte) error {
	var res DomainRegisterActionsRequest
...
// String returns the JSON body of this domain register actions request. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *DomainRegisterActionsRequest) String() string {
	if m == nil {
		return "<nil>"
	}
