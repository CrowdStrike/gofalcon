...
var itautomationPolicyTypeTargetPropEnum []interface{}
...
// String returns the JSON body of this itautomation policy. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *ItautomationPolicy) String() string {
	if m == nil {
		return "<nil>"
	}
