...
// String returns the JSON body of this content update ring assignment settings v1. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *ContentUpdateRingAssignmentSettingsV1) String() string {
	if m == nil {
		return "<nil>"
	}
