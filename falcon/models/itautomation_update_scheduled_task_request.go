...
// ItautomationUpdateScheduledTaskRequest itautomation update scheduled task request
//
// swagger:model itautomation.UpdateScheduledTaskRequest
type ItautomationUpdateScheduledTaskRequest struct {
	...
	Schedule *FalconforitapiSchedule `json:"schedule,omitempty"`
...
// Validate validates this itautomation update scheduled task request
func (m *ItautomationUpdateScheduledTaskRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ItautomationUpdateScheduledTaskRequest) validateGuardrails(formats strfmt.Registry) error {
...
func (m *ItautomationUpdateScheduledTaskRequest) validateSchedule(formats strfmt.Registry) error {
...
func (m *ItautomationUpdateScheduledTaskRequest) validateTriggerCondition(formats strfmt.Registry) error {
...
// ContextValidate validate this itautomation update scheduled task request based on the context it is used
func (m *ItautomationUpdateScheduledTaskRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ItautomationUpdateScheduledTaskRequest) contextValidateGuardrails(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ItautomationUpdateScheduledTaskRequest) contextValidateSchedule(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ItautomationUpdateScheduledTaskRequest) contextValidateTriggerCondition(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ItautomationUpdateScheduledTaskRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ItautomationUpdateScheduledTaskRequest) UnmarshalBinary(b []byte) error {
	var res ItautomationUpdateScheduledTaskRequest
...
// String returns the JSON body of this itautomation update scheduled task request. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *ItautomationUpdateScheduledTaskRequest) String() string {
	if m == nil {
		return "<nil>"
	}
