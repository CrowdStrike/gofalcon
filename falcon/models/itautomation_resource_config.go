...
var itautomationResourceConfigTypeMemoryAllocationUnitPropEnum []interface{}
...
// String returns the JSON body of this itautomation resource config. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *ItautomationResourceConfig) String() string {
	if m == nil {
		return "<nil>"
	}
