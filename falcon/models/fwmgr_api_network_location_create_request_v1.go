...
// String returns the JSON body of this fwmgr api network location create request v1. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *FwmgrAPINetworkLocationCreateRequestV1) String() string {
	if m == nil {
		return "<nil>"
	}
