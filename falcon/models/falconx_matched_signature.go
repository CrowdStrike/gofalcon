...
func (m *FalconxMatchedSignature) UnmarshalBinary(b []byte) error {
	var res FalconxMatchedSignature
...
// String returns the JSON body of this falconx matched signature. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *FalconxMatchedSignature) String() string {
	if m == nil {
		return "<nil>"
	}
