...
func (m *DriftindicatorsDriftIndicatorsFieldValue) validateMeta(formats strfmt.Registry) error {
...
func (m *DriftindicatorsDriftIndicatorsFieldValue) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DriftindicatorsDriftIndicatorsFieldValue) UnmarshalBinary(b []byte) error {
	var res DriftindicatorsDriftIndicatorsFieldValue
...
// String returns the JSON body of this driftindicators drift indicators field value. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *DriftindicatorsDriftIndicatorsFieldValue) String() string {
	if m == nil {
		return "<nil>"
	}
