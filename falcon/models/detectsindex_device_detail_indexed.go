...
// DetectsindexDeviceDetailIndexed detectsindex device detail indexed
//
// swagger:model detectsindex.DeviceDetailIndexed
type DetectsindexDeviceDetailIndexed struct {
...
// Validate validates this detectsindex device detail indexed
func (m *DetectsindexDeviceDetailIndexed) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DetectsindexDeviceDetailIndexed) validateCid(formats strfmt.Registry) error {
...
func (m *DetectsindexDeviceDetailIndexed) validateDeviceID(formats strfmt.Registry) error {
...
// ContextValidate validates this detectsindex device detail indexed based on context it is used
func (m *DetectsindexDeviceDetailIndexed) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *DetectsindexDeviceDetailIndexed) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *DetectsindexDeviceDetailIndexed) UnmarshalBinary(b []byte) error {
	var res DetectsindexDeviceDetailIndexed
