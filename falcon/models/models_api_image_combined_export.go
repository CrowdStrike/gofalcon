...
func (m *ModelsAPIImageCombinedExport) validateAiRelated(formats strfmt.Registry) error {
...
// String returns the JSON body of this models API image combined export. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *ModelsAPIImageCombinedExport) String() string {
	if m == nil {
		return "<nil>"
	}
