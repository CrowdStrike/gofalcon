...
type MsaAggregateQueryRequest struct {
	...
	// extended bounds
	ExtendedBounds *MsaExtendedBoundsSpec `json:"extended_bounds,omitempty"`
	...
	// filters spec
	// Required: true
	FiltersSpec *MsaAPIFiltersSpec `json:"filters_spec"`
...
func (m *MsaAggregateQueryRequest) validateExtendedBounds(formats strfmt.Registry) error {
...
func (m *MsaAggregateQueryRequest) validateFiltersSpec(formats strfmt.Registry) error {
...
func (m *MsaAggregateQueryRequest) contextValidateExtendedBounds(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MsaAggregateQueryRequest) contextValidateFiltersSpec(ctx context.Context, formats strfmt.Registry) error {
...
// String returns the JSON body of this msa aggregate query request. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *MsaAggregateQueryRequest) String() string {
	if m == nil {
		return "<nil>"
	}
