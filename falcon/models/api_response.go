...
type APIResponse struct {
	...
	// resources
	// Required: true
	Resources APIResponseResources `json:"resources"`
}
...
func (m *APIResponse) validateMeta(formats strfmt.Registry) error {
...
func (m *APIResponse) validateResources(formats strfmt.Registry) error {
...
func (m *APIResponse) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
// String returns the JSON body of this api response. It implements
