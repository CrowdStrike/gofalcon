...
func (m *ApidomainQueryResponseWrapperV1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ApidomainQueryResponseWrapperV1) validateErrors(formats strfmt.Registry) error {
...
func (m *ApidomainQueryResponseWrapperV1) validateMeta(formats strfmt.Registry) error {
...
func (m *ApidomainQueryResponseWrapperV1) validateResources(formats strfmt.Registry) error {
...
func (m *ApidomainQueryResponseWrapperV1) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ApidomainQueryResponseWrapperV1) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ApidomainQueryResponseWrapperV1) UnmarshalBinary(b []byte) error {
	var res ApidomainQueryResponseWrapperV1
...
// String returns the JSON body of this apidomain query response wrapper v1. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *ApidomainQueryResponseWrapperV1) String() string {
	if m == nil {
		return "<nil>"
	}
