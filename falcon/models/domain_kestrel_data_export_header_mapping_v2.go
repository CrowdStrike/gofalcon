...
// String returns the JSON body of this domain kestrel data export header mapping v2. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *DomainKestrelDataExportHeaderMappingV2) String() string {
	if m == nil {
		return "<nil>"
	}
