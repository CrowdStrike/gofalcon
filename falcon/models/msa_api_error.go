...
func (m *MsaAPIError) validateCode(formats strfmt.Registry) error {
...
func (m *MsaAPIError) validateMessage(formats strfmt.Registry) error {
...
// String returns the JSON body of this msa API error. It implements
