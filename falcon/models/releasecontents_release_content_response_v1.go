...
// String returns the JSON body of this releasecontents release content response v1. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *ReleasecontentsReleaseContentResponseV1) String() string {
	if m == nil {
		return "<nil>"
	}
