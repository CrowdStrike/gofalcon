...
func (m *DeviceControlUpdatePoliciesReqV1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DeviceControlUpdatePoliciesReqV1) validateResources(formats strfmt.Registry) error {
...
func (m *DeviceControlUpdatePoliciesReqV1) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DeviceControlUpdatePoliciesReqV1) UnmarshalBinary(b []byte) error {
	var res DeviceControlUpdatePoliciesReqV1
...
// String returns the JSON body of this device control update policies req v1. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *DeviceControlUpdatePoliciesReqV1) String() string {
	if m == nil {
		return "<nil>"
	}
