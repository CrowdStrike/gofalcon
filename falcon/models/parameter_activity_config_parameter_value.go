...
// String returns the JSON body of this parameter activity config parameter value. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *ParameterActivityConfigParameterValue) String() string {
	if m == nil {
		return "<nil>"
	}
