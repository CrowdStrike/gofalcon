...
func (m *DetectionsAPICombinedDetections) validateMeta(formats strfmt.Registry) error {
...
func (m *DetectionsAPICombinedDetections) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DetectionsAPICombinedDetections) UnmarshalBinary(b []byte) error {
	var res DetectionsAPICombinedDetections
...
// String returns the JSON body of this detections api combined detections. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *DetectionsAPICombinedDetections) String() string {
	if m == nil {
		return "<nil>"
	}
