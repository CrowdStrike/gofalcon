...
func (m *ModelsPolicyEntityResponse) validateMeta(formats strfmt.Registry) error {
...
func (m *ModelsPolicyEntityResponse) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ModelsPolicyEntityResponse) UnmarshalBinary(b []byte) error {
	var res ModelsPolicyEntityResponse
...
// String returns the JSON body of this models policy entity response. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *ModelsPolicyEntityResponse) String() string {
	if m == nil {
		return "<nil>"
	}
