...
// String returns the JSON body of this domain discover API application browser extension installation. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *DomainDiscoverAPIApplicationBrowserExtensionInstallation) String() string {
	if m == nil {
		return "<nil>"
	}
