...
// TaskexecutionsTaskExecution taskexecutions task execution
//
// swagger:model taskexecutions.TaskExecution
type TaskexecutionsTaskExecution struct {

	// Key-value pairs of parameter values to pass to the job. Example: {'api_key': 'abc123', 'region': 'us-east-1'}
	Arguments map[string]string `json:"arguments,omitempty"`

	// Interval to wait for new hosts discovery. Example: 1h
	DiscoverNewHostsInterval string `json:"discover_new_hosts_interval,omitempty"`

	// Interval between executing on different hosts. Example: 5m
	...
	StatusByStage *TaskexecutionsTaskStageExecutionStatus `json:"status_by_stage,omitempty"`
	...
	TaskParameters []*PublicTaskParameter `json:"task_parameters"`

	// Type of task execution. Example: query
	// Required: true
	...
	// Time to wait for hosts to become online. Example: 1h
	WaitTime string `json:"wait_time,omitempty"`
}

// Validate validates this taskexecutions task execution
func (m *TaskexecutionsTaskExecution) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *TaskexecutionsTaskExecution) validateGuardrails(formats strfmt.Registry) error {
...
func (m *TaskexecutionsTaskExecution) validateID(formats strfmt.Registry) error {
...
func (m *TaskexecutionsTaskExecution) validateQueries(formats strfmt.Registry) error {
...
func (m *TaskexecutionsTaskExecution) validateRemediations(formats strfmt.Registry) error {
...
func (m *TaskexecutionsTaskExecution) validateRunBy(formats strfmt.Registry) error {
...
func (m *TaskexecutionsTaskExecution) validateRunType(formats strfmt.Registry) error {
...
func (m *TaskexecutionsTaskExecution) validateStatusByStage(formats strfmt.Registry) error {
...
func (m *TaskexecutionsTaskExecution) validateTarget(formats strfmt.Registry) error {
...
func (m *TaskexecutionsTaskExecution) validateTaskParameters(formats strfmt.Registry) error {
...
var taskexecutionsTaskExecutionTypeTaskTypePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		taskexecutionsTaskExecutionTypeTaskTypePropEnum = append(taskexecutionsTaskExecutionTypeTaskTypePropEnum, v)
	}
}

const (

	// TaskexecutionsTaskExecutionTaskTypeQuery captures enum value "query"
	TaskexecutionsTaskExecutionTaskTypeQuery string = "query"

	// TaskexecutionsTaskExecutionTaskTypeRemediation captures enum value "remediation"
	TaskexecutionsTaskExecutionTaskTypeRemediation string = "remediation"
)

// prop value enum
func (m *TaskexecutionsTaskExecution) validateTaskTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, taskexecutionsTaskExecutionTypeTaskTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *TaskexecutionsTaskExecution) validateTaskType(formats strfmt.Registry) error {
...
func (m *TaskexecutionsTaskExecution) validateTriggerCondition(formats strfmt.Registry) error {
...
func (m *TaskexecutionsTaskExecution) validateVerificationCondition(formats strfmt.Registry) error {
...
// ContextValidate validate this taskexecutions task execution based on the context it is used
func (m *TaskexecutionsTaskExecution) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *TaskexecutionsTaskExecution) contextValidateGuardrails(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TaskexecutionsTaskExecution) contextValidateQueries(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TaskexecutionsTaskExecution) contextValidateRemediations(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TaskexecutionsTaskExecution) contextValidateStatusByStage(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TaskexecutionsTaskExecution) contextValidateTaskParameters(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TaskexecutionsTaskExecution) contextValidateTriggerCondition(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TaskexecutionsTaskExecution) contextValidateVerificationCondition(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TaskexecutionsTaskExecution) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *TaskexecutionsTaskExecution) UnmarshalBinary(b []byte) error {
	var res TaskexecutionsTaskExecution
