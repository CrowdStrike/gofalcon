...
// String returns the JSON body of this api identifiable agent version definition. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *APIIdentifiableAgentVersionDefinition) String() string {
	if m == nil {
		return "<nil>"
	}
