...
func (m *SensorUpdateCreatePoliciesReqV1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SensorUpdateCreatePoliciesReqV1) validateResources(formats strfmt.Registry) error {
...
func (m *SensorUpdateCreatePoliciesReqV1) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SensorUpdateCreatePoliciesReqV1) UnmarshalBinary(b []byte) error {
	var res SensorUpdateCreatePoliciesReqV1
...
// String returns the JSON body of this sensor update create policies req v1. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *SensorUpdateCreatePoliciesReqV1) String() string {
	if m == nil {
		return "<nil>"
	}
