...
// String returns the JSON body of this registryassessment external registry patch payload. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *RegistryassessmentExternalRegistryPatchPayload) String() string {
	if m == nil {
		return "<nil>"
	}
