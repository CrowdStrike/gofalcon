...
// String returns the JSON body of this types get services related entity group by fields. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *TypesGetServicesRelatedEntityGroupByFields) String() string {
	if m == nil {
		return "<nil>"
	}
