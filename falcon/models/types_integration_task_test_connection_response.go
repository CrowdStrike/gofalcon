...
// String returns the JSON body of this types integration task test connection response. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *TypesIntegrationTaskTestConnectionResponse) String() string {
	if m == nil {
		return "<nil>"
	}
