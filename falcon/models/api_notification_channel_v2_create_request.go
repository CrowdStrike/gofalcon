...
// String returns the JSON body of this api notification channel v2 create request. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *APINotificationChannelV2CreateRequest) String() string {
	if m == nil {
		return "<nil>"
	}
