...
func (m *DeviceapiRequestMeta) validatePagination(formats strfmt.Registry) error {
...
func (m *DeviceapiRequestMeta) validateQueryTime(formats strfmt.Registry) error {
...
func (m *DeviceapiRequestMeta) validateTraceID(formats strfmt.Registry) error {
...
func (m *DeviceapiRequestMeta) contextValidatePagination(ctx context.Context, formats strfmt.Registry) error {
...
// String returns the JSON body of this deviceapi request meta. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *DeviceapiRequestMeta) String() string {
	if m == nil {
		return "<nil>"
	}
