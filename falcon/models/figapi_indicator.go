...
// FigapiIndicator figapi indicator
//
// swagger:model figapi.Indicator
type FigapiIndicator struct {
...
// Validate validates this figapi indicator
func (m *FigapiIndicator) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *FigapiIndicator) validateAdversaries(formats strfmt.Registry) error {
...
func (m *FigapiIndicator) validateCertificates(formats strfmt.Registry) error {
...
func (m *FigapiIndicator) validateFileDetails(formats strfmt.Registry) error {
...
func (m *FigapiIndicator) validateIPV4Details(formats strfmt.Registry) error {
...
func (m *FigapiIndicator) validateIPV6Details(formats strfmt.Registry) error {
...
func (m *FigapiIndicator) validateReports(formats strfmt.Registry) error {
...
func (m *FigapiIndicator) validateSoftwarePackages(formats strfmt.Registry) error {
...
func (m *FigapiIndicator) validateThreats(formats strfmt.Registry) error {
...
func (m *FigapiIndicator) validateURLDetails(formats strfmt.Registry) error {
...
// ContextValidate validate this figapi indicator based on the context it is used
func (m *FigapiIndicator) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *FigapiIndicator) contextValidateAdversaries(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FigapiIndicator) contextValidateCertificates(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FigapiIndicator) contextValidateFileDetails(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FigapiIndicator) contextValidateIPV4Details(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FigapiIndicator) contextValidateIPV6Details(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FigapiIndicator) contextValidateReports(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FigapiIndicator) contextValidateSectors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FigapiIndicator) contextValidateSoftwarePackages(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FigapiIndicator) contextValidateThreats(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FigapiIndicator) contextValidateURLDetails(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FigapiIndicator) contextValidateVulnerabilities(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FigapiIndicator) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *FigapiIndicator) UnmarshalBinary(b []byte) error {
	var res FigapiIndicator
