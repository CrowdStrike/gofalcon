...
func (m *RulegroupsPolicyAssignment) validateHref(formats strfmt.Registry) error {
...
func (m *RulegroupsPolicyAssignment) validateID(formats strfmt.Registry) error {
...
func (m *RulegroupsPolicyAssignment) UnmarshalBinary(b []byte) error {
	var res RulegroupsPolicyAssignment
...
// String returns the JSON body of this rulegroups policy assignment. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *RulegroupsPolicyAssignment) String() string {
	if m == nil {
		return "<nil>"
	}
