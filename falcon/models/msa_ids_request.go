...
func (m *MsaIdsRequest) validateIds(formats strfmt.Registry) error {
...
// String returns the JSON body of this msa ids request. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *MsaIdsRequest) String() string {
	if m == nil {
		return "<nil>"
	}
