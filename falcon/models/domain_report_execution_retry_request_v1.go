...
func (m *DomainReportExecutionRetryRequestV1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DomainReportExecutionRetryRequestV1) validateID(formats strfmt.Registry) error {
...
func (m *DomainReportExecutionRetryRequestV1) UnmarshalBinary(b []byte) error {
	var res DomainReportExecutionRetryRequestV1
...
// String returns the JSON body of this domain report execution retry request v1. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *DomainReportExecutionRetryRequestV1) String() string {
	if m == nil {
		return "<nil>"
	}
