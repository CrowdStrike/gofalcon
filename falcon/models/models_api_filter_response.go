...
func (m *ModelsAPIFilterResponse) validateBuckets(formats strfmt.Registry) error {
...
func (m *ModelsAPIFilterResponse) validateName(formats strfmt.Registry) error {
...
func (m *ModelsAPIFilterResponse) contextValidateBuckets(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ModelsAPIFilterResponse) UnmarshalBinary(b []byte) error {
	var res ModelsAPIFilterResponse
...
// String returns the JSON body of this models API filter response. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *ModelsAPIFilterResponse) String() string {
	if m == nil {
		return "<nil>"
	}
