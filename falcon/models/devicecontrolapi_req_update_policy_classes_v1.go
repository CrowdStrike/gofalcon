...
// String returns the JSON body of this devicecontrolapi req update policy classes v1. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *DevicecontrolapiReqUpdatePolicyClassesV1) String() string {
	if m == nil {
		return "<nil>"
	}
