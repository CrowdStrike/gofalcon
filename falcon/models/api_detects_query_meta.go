...
func (m *APIDetectsQueryMeta) validatePagination(formats strfmt.Registry) error {
...
func (m *APIDetectsQueryMeta) validateQueryTime(formats strfmt.Registry) error {
...
func (m *APIDetectsQueryMeta) validateTraceID(formats strfmt.Registry) error {
...
func (m *APIDetectsQueryMeta) contextValidatePagination(ctx context.Context, formats strfmt.Registry) error {
...
// String returns the JSON body of this api detects query meta. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *APIDetectsQueryMeta) String() string {
	if m == nil {
		return "<nil>"
	}
