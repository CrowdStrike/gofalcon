...
func (m *ModelsRegistryCredentialsResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ModelsRegistryCredentialsResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *ModelsRegistryCredentialsResponse) validateMeta(formats strfmt.Registry) error {
...
func (m *ModelsRegistryCredentialsResponse) validateResources(formats strfmt.Registry) error {
...
func (m *ModelsRegistryCredentialsResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ModelsRegistryCredentialsResponse) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ModelsRegistryCredentialsResponse) UnmarshalBinary(b []byte) error {
	var res ModelsRegistryCredentialsResponse
...
// String returns the JSON body of this models registry credentials response. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *ModelsRegistryCredentialsResponse) String() string {
	if m == nil {
		return "<nil>"
	}
