...
func (m *FirewallUpdateFirewallPoliciesReqV1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *FirewallUpdateFirewallPoliciesReqV1) validateResources(formats strfmt.Registry) error {
...
func (m *FirewallUpdateFirewallPoliciesReqV1) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FirewallUpdateFirewallPoliciesReqV1) UnmarshalBinary(b []byte) error {
	var res FirewallUpdateFirewallPoliciesReqV1
...
// String returns the JSON body of this firewall update firewall policies req v1. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *FirewallUpdateFirewallPoliciesReqV1) String() string {
	if m == nil {
		return "<nil>"
	}
