...
func (m *DetectsapiResponseFields) validateErrors(formats strfmt.Registry) error {
...
func (m *DetectsapiResponseFields) validateMeta(formats strfmt.Registry) error {
...
func (m *DetectsapiResponseFields) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DetectsapiResponseFields) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DetectsapiResponseFields) UnmarshalBinary(b []byte) error {
	var res DetectsapiResponseFields
...
// String returns the JSON body of this detectsapi response fields. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *DetectsapiResponseFields) String() string {
	if m == nil {
		return "<nil>"
	}
