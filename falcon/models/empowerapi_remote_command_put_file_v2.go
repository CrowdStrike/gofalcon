...
func (m *EmpowerapiRemoteCommandPutFileV2) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *EmpowerapiRemoteCommandPutFileV2) validateCreatedTimestamp(formats strfmt.Registry) error {
...
func (m *EmpowerapiRemoteCommandPutFileV2) validateModifiedTimestamp(formats strfmt.Registry) error {
...
func (m *EmpowerapiRemoteCommandPutFileV2) validateRunAttemptCount(formats strfmt.Registry) error {
...
func (m *EmpowerapiRemoteCommandPutFileV2) validateRunSuccessCount(formats strfmt.Registry) error {
...
func (m *EmpowerapiRemoteCommandPutFileV2) validateWorkflowIsDisruptive(formats strfmt.Registry) error {
...
func (m *EmpowerapiRemoteCommandPutFileV2) UnmarshalBinary(b []byte) error {
	var res EmpowerapiRemoteCommandPutFileV2
...
// String returns the JSON body of this empowerapi remote command put file v2. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *EmpowerapiRemoteCommandPutFileV2) String() string {
	if m == nil {
		return "<nil>"
	}
