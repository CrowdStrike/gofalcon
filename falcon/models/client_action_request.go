...
func (m *ClientActionRequest) validateIds(formats strfmt.Registry) error {
...
// String returns the JSON body of this client action request. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *ClientActionRequest) String() string {
	if m == nil {
		return "<nil>"
	}
