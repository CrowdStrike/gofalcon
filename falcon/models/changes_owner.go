...
func (m *ChangesOwner) validateAfter(formats strfmt.Registry) error {
...
func (m *ChangesOwner) validateBefore(formats strfmt.Registry) error {
...
func (m *ChangesOwner) contextValidateAfter(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ChangesOwner) contextValidateBefore(ctx context.Context, formats strfmt.Registry) error {
...
// String returns the JSON body of this changes owner. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *ChangesOwner) String() string {
	if m == nil {
		return "<nil>"
	}
