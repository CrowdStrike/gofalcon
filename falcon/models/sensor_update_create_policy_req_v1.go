...
func (m *SensorUpdateCreatePolicyReqV1) validateName(formats strfmt.Registry) error {
...
var sensorUpdateCreatePolicyReqV1TypePlatformNamePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		sensorUpdateCreatePolicyReqV1TypePlatformNamePropEnum = append(sensorUpdateCreatePolicyReqV1TypePlatformNamePropEnum, v)
	}
}
...
// prop value enum
func (m *SensorUpdateCreatePolicyReqV1) validatePlatformNameEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, sensorUpdateCreatePolicyReqV1TypePlatformNamePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *SensorUpdateCreatePolicyReqV1) validatePlatformName(formats strfmt.Registry) error {
...
func (m *SensorUpdateCreatePolicyReqV1) validateSettings(formats strfmt.Registry) error {
...
func (m *SensorUpdateCreatePolicyReqV1) contextValidateSettings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SensorUpdateCreatePolicyReqV1) UnmarshalBinary(b []byte) error {
	var res SensorUpdateCreatePolicyReqV1
...
// String returns the JSON body of this sensor update create policy req v1. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *SensorUpdateCreatePolicyReqV1) String() string {
	if m == nil {
		return "<nil>"
	}
