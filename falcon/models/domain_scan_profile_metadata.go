...
func (m *DomainScanProfileMetadata) validateHostID(formats strfmt.Registry) error {
...
func (m *DomainScanProfileMetadata) validateLastUpdated(formats strfmt.Registry) error {
...
func (m *DomainScanProfileMetadata) UnmarshalBinary(b []byte) error {
	var res DomainScanProfileMetadata
...
// String returns the JSON body of this domain scan profile metadata. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *DomainScanProfileMetadata) String() string {
	if m == nil {
		return "<nil>"
	}
