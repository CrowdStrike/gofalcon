...
// DomainDiscoverAPIIoTHost domain discover API io t host
//
...
type DomainDiscoverAPIIoTHost struct {
	...
	Triage *DomainDiscoverAPIIoTHostTriage `json:"triage,omitempty"`
...
func (m *DomainDiscoverAPIIoTHost) validateBiosHashesData(formats strfmt.Registry) error {
...
func (m *DomainDiscoverAPIIoTHost) validateOsSecurity(formats strfmt.Registry) error {
...
func (m *DomainDiscoverAPIIoTHost) contextValidateBiosHashesData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DomainDiscoverAPIIoTHost) contextValidateOsSecurity(ctx context.Context, formats strfmt.Registry) error {
