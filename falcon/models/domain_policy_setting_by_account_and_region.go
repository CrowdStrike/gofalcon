...
// String returns the JSON body of this domain policy setting by account and region. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *DomainPolicySettingByAccountAndRegion) String() string {
	if m == nil {
		return "<nil>"
	}
