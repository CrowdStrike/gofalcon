...
func (m *MalquerySearchParameter) validateType(formats strfmt.Registry) error {
...
func (m *MalquerySearchParameter) validateValue(formats strfmt.Registry) error {
...
func (m *MalquerySearchParameter) UnmarshalBinary(b []byte) error {
	var res MalquerySearchParameter
...
// String returns the JSON body of this malquery search parameter. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *MalquerySearchParameter) String() string {
	if m == nil {
		return "<nil>"
	}
