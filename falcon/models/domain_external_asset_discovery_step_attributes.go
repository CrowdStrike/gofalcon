...
// String returns the JSON body of this domain external asset discovery step attributes. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *DomainExternalAssetDiscoveryStepAttributes) String() string {
	if m == nil {
		return "<nil>"
	}
