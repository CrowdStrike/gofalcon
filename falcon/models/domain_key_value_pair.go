...
func (m *DomainKeyValuePair) validateName(formats strfmt.Registry) error {
...
func (m *DomainKeyValuePair) validateValue(formats strfmt.Registry) error {
...
// String returns the JSON body of this domain key value pair. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *DomainKeyValuePair) String() string {
	if m == nil {
		return "<nil>"
	}
