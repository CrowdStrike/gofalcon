...
type RestapiLookupIndicatorResponse struct {
	...
	// resources
	// Required: true
	Resources []*RestapiLookupIndicator `json:"resources"`
}
...
// String returns the JSON body of this restapi lookup indicator response. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *RestapiLookupIndicatorResponse) String() string {
	if m == nil {
		return "<nil>"
	}
