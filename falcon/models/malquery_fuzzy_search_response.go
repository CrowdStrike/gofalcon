...
func (m *MalqueryFuzzySearchResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *MalqueryFuzzySearchResponse) validateMeta(formats strfmt.Registry) error {
...
func (m *MalqueryFuzzySearchResponse) validateResources(formats strfmt.Registry) error {
...
func (m *MalqueryFuzzySearchResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MalqueryFuzzySearchResponse) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MalqueryFuzzySearchResponse) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MalqueryFuzzySearchResponse) UnmarshalBinary(b []byte) error {
	var res MalqueryFuzzySearchResponse
...
// String returns the JSON body of this malquery fuzzy search response. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *MalqueryFuzzySearchResponse) String() string {
	if m == nil {
		return "<nil>"
	}
