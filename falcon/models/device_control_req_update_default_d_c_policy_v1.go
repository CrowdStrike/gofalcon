...
// String returns the JSON body of this device control req update default d c policy v1. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *DeviceControlReqUpdateDefaultDCPolicyV1) String() string {
	if m == nil {
		return "<nil>"
	}
