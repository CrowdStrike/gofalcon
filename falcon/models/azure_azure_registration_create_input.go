...
func (m *AzureAzureRegistrationCreateInput) validateDspmRegions(formats strfmt.Registry) error {
...
func (m *AzureAzureRegistrationCreateInput) validatePrimaryDomain(formats strfmt.Registry) error {
...
// String returns the JSON body of this azure azure registration create input. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *AzureAzureRegistrationCreateInput) String() string {
	if m == nil {
		return "<nil>"
	}
