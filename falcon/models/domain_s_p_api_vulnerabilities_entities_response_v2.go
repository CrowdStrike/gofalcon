...
// String returns the JSON body of this domain s p API vulnerabilities entities response v2. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *DomainSPAPIVulnerabilitiesEntitiesResponseV2) String() string {
	if m == nil {
		return "<nil>"
	}
