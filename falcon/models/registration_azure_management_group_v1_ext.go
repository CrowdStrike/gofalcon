...
// String returns the JSON body of this registration azure management group v1 ext. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *RegistrationAzureManagementGroupV1Ext) String() string {
	if m == nil {
		return "<nil>"
	}
