...
func (m *HostGroupsCreateGroupsReqV1) validateResources(formats strfmt.Registry) error {
...
func (m *HostGroupsCreateGroupsReqV1) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HostGroupsCreateGroupsReqV1) UnmarshalBinary(b []byte) error {
	var res HostGroupsCreateGroupsReqV1
...
// String returns the JSON body of this host groups create groups req v1. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *HostGroupsCreateGroupsReqV1) String() string {
	if m == nil {
		return "<nil>"
	}
