...
// String returns the JSON body of this domain API evaluation logic state comparison v1. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *DomainAPIEvaluationLogicStateComparisonV1) String() string {
	if m == nil {
		return "<nil>"
	}
