...
func (m *IocapiResponseMeta) validatePagination(formats strfmt.Registry) error {
...
func (m *IocapiResponseMeta) validateQueryTime(formats strfmt.Registry) error {
...
func (m *IocapiResponseMeta) validateTraceID(formats strfmt.Registry) error {
...
func (m *IocapiResponseMeta) contextValidatePagination(ctx context.Context, formats strfmt.Registry) error {
...
// String returns the JSON body of this iocapi response meta. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *IocapiResponseMeta) String() string {
	if m == nil {
		return "<nil>"
	}
