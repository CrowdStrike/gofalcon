...
func (m *APIDevicesRanOnRespV1) validateErrors(formats strfmt.Registry) error {
...
func (m *APIDevicesRanOnRespV1) validateMeta(formats strfmt.Registry) error {
...
func (m *APIDevicesRanOnRespV1) validateResources(formats strfmt.Registry) error {
...
func (m *APIDevicesRanOnRespV1) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *APIDevicesRanOnRespV1) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
// String returns the JSON body of this api devices ran on resp v1. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *APIDevicesRanOnRespV1) String() string {
	if m == nil {
		return "<nil>"
	}
