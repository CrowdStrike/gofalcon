...
func (m *APIDevicesRanOnRespV1) validateMsaMetaInfo(formats strfmt.Registry) error {
...
func (m *APIDevicesRanOnRespV1) contextValidateMsaMetaInfo(ctx context.Context, formats strfmt.Registry) error {
