...
func (m *APITemplateV1UpdateRequest) validateAccessTags(formats strfmt.Registry) error {
...
func (m *APITemplateV1UpdateRequest) contextValidateAccessTags(ctx context.Context, formats strfmt.Registry) error {
...
// String returns the JSON body of this api template v1 update request. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *APITemplateV1UpdateRequest) String() string {
	if m == nil {
		return "<nil>"
	}
