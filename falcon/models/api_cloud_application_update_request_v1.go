...
//
// swagger:model api.CloudApplicationUpdateRequestV1
...
// ContextValidate validate this api cloud application update request v1 based on the context it is used
func (m *APICloudApplicationUpdateRequestV1) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *APICloudApplicationUpdateRequestV1) contextValidateUrls(ctx context.Context, formats strfmt.Registry) error {
...
func (m *APICloudApplicationUpdateRequestV1) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *APICloudApplicationUpdateRequestV1) UnmarshalBinary(b []byte) error {
	var res APICloudApplicationUpdateRequestV1
...
// String returns the JSON body of this api cloud application update request v1. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *APICloudApplicationUpdateRequestV1) String() string {
	if m == nil {
		return "<nil>"
	}
