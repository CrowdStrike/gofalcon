...
// ActivitiesExternalActivity activities external activity
//
// swagger:model activities.ExternalActivity
type ActivitiesExternalActivity struct {
...
// Validate validates this activities external activity
func (m *ActivitiesExternalActivity) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ActivitiesExternalActivity) validateCid(formats strfmt.Registry) error {
...
func (m *ActivitiesExternalActivity) validateDependencies(formats strfmt.Registry) error {
...
func (m *ActivitiesExternalActivity) validateDescription(formats strfmt.Registry) error {
...
func (m *ActivitiesExternalActivity) validateDisruptive(formats strfmt.Registry) error {
...
func (m *ActivitiesExternalActivity) validateHasPermission(formats strfmt.Registry) error {
...
func (m *ActivitiesExternalActivity) validateID(formats strfmt.Registry) error {
...
func (m *ActivitiesExternalActivity) validateInputFields(formats strfmt.Registry) error {
...
func (m *ActivitiesExternalActivity) validateOutputFields(formats strfmt.Registry) error {
...
// ContextValidate validate this activities external activity based on the context it is used
func (m *ActivitiesExternalActivity) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ActivitiesExternalActivity) contextValidateDependencies(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ActivitiesExternalActivity) contextValidateInputFields(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ActivitiesExternalActivity) UnmarshalBinary(b []byte) error {
	var res ActivitiesExternalActivity
