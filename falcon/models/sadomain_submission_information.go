...
func (m *SadomainSubmissionInformation) validateDate(formats strfmt.Registry) error {
...
func (m *SadomainSubmissionInformation) validateStatus(formats strfmt.Registry) error {
...
func (m *SadomainSubmissionInformation) validateUserUUID(formats strfmt.Registry) error {
...
func (m *SadomainSubmissionInformation) UnmarshalBinary(b []byte) error {
	var res SadomainSubmissionInformation
...
// String returns the JSON body of this sadomain submission information. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *SadomainSubmissionInformation) String() string {
	if m == nil {
		return "<nil>"
	}
