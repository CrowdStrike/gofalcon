...
func (m *FirewallCreateFirewallPoliciesReqV1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *FirewallCreateFirewallPoliciesReqV1) validateResources(formats strfmt.Registry) error {
...
func (m *FirewallCreateFirewallPoliciesReqV1) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FirewallCreateFirewallPoliciesReqV1) UnmarshalBinary(b []byte) error {
	var res FirewallCreateFirewallPoliciesReqV1
...
// String returns the JSON body of this firewall create firewall policies req v1. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *FirewallCreateFirewallPoliciesReqV1) String() string {
	if m == nil {
		return "<nil>"
	}
