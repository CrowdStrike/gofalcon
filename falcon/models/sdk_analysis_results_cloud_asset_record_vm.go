...
// String returns the JSON body of this sdk analysis results cloud asset record VM. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *SdkAnalysisResultsCloudAssetRecordVM) String() string {
	if m == nil {
		return "<nil>"
	}
