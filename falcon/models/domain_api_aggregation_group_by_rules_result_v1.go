...
// String returns the JSON body of this domain API aggregation group by rules result v1. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *DomainAPIAggregationGroupByRulesResultV1) String() string {
	if m == nil {
		return "<nil>"
	}
