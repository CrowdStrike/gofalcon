...
func (m *APIMetaInfo) validatePagination(formats strfmt.Registry) error {
...
func (m *APIMetaInfo) validateQueryTime(formats strfmt.Registry) error {
...
func (m *APIMetaInfo) validateTraceID(formats strfmt.Registry) error {
...
func (m *APIMetaInfo) contextValidatePagination(ctx context.Context, formats strfmt.Registry) error {
...
// String returns the JSON body of this api meta info. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *APIMetaInfo) String() string {
	if m == nil {
		return "<nil>"
	}
