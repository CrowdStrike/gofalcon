...
func (m *DetectionsAPIAssessmentDetections) validateMeta(formats strfmt.Registry) error {
...
func (m *DetectionsAPIAssessmentDetections) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DetectionsAPIAssessmentDetections) UnmarshalBinary(b []byte) error {
	var res DetectionsAPIAssessmentDetections
...
// String returns the JSON body of this detections api assessment detections. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *DetectionsAPIAssessmentDetections) String() string {
	if m == nil {
		return "<nil>"
	}
