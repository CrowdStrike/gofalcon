...
func (m *K8sregAWSAccountPermissionsStatus) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *K8sregAWSAccountPermissionsStatus) validateName(formats strfmt.Registry) error {
...
func (m *K8sregAWSAccountPermissionsStatus) validateStatus(formats strfmt.Registry) error {
...
func (m *K8sregAWSAccountPermissionsStatus) UnmarshalBinary(b []byte) error {
	var res K8sregAWSAccountPermissionsStatus
