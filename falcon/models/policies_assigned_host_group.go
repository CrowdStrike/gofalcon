...
func (m *PoliciesAssignedHostGroup) validateHref(formats strfmt.Registry) error {
...
func (m *PoliciesAssignedHostGroup) validateID(formats strfmt.Registry) error {
...
func (m *PoliciesAssignedHostGroup) UnmarshalBinary(b []byte) error {
	var res PoliciesAssignedHostGroup
...
// String returns the JSON body of this policies assigned host group. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *PoliciesAssignedHostGroup) String() string {
	if m == nil {
		return "<nil>"
	}
