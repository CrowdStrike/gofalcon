...
func (m *DomainReconAPIError) validateCode(formats strfmt.Registry) error {
...
func (m *DomainReconAPIError) validateDetails(formats strfmt.Registry) error {
...
func (m *DomainReconAPIError) validateMessage(formats strfmt.Registry) error {
...
func (m *DomainReconAPIError) contextValidateDetails(ctx context.Context, formats strfmt.Registry) error {
...
// String returns the JSON body of this domain recon API error. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *DomainReconAPIError) String() string {
	if m == nil {
		return "<nil>"
	}
