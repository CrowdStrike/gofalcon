...
// String returns the JSON body of this assetgroupmanager v1 create cloud group request. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *AssetgroupmanagerV1CreateCloudGroupRequest) String() string {
	if m == nil {
		return "<nil>"
	}
