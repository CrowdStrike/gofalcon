...
// AzureAzureRegistrationUpdateV1 azure azure registration update v1
//
// swagger:model azure.AzureRegistrationUpdateV1
type AzureAzureRegistrationUpdateV1 struct {
...
// Validate validates this azure azure registration update v1
func (m *AzureAzureRegistrationUpdateV1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *AzureAzureRegistrationUpdateV1) validateCustomEntraIDPermissions(formats strfmt.Registry) error {
...
func (m *AzureAzureRegistrationUpdateV1) validateDspmEnabled(formats strfmt.Registry) error {
...
func (m *AzureAzureRegistrationUpdateV1) validateProducts(formats strfmt.Registry) error {
...
func (m *AzureAzureRegistrationUpdateV1) validateRegistrationID(formats strfmt.Registry) error {
...
func (m *AzureAzureRegistrationUpdateV1) validateRtvdEnabled(formats strfmt.Registry) error {
...
func (m *AzureAzureRegistrationUpdateV1) validateRtvdRegions(formats strfmt.Registry) error {
...
// ContextValidate validate this azure azure registration update v1 based on the context it is used
func (m *AzureAzureRegistrationUpdateV1) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *AzureAzureRegistrationUpdateV1) contextValidateProducts(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AzureAzureRegistrationUpdateV1) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *AzureAzureRegistrationUpdateV1) UnmarshalBinary(b []byte) error {
	var res AzureAzureRegistrationUpdateV1
