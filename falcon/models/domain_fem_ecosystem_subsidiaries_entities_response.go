...
// String returns the JSON body of this domain fem ecosystem subsidiaries entities response. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *DomainFemEcosystemSubsidiariesEntitiesResponse) String() string {
	if m == nil {
		return "<nil>"
	}
