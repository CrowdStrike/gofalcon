...
type DomainScan struct {
	...
	// rollup complete at version
	RollupCompleteAtVersion int32 `json:"rollup_complete_at_version,omitempty"`
...
// String returns the JSON body of this domain scan. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *DomainScan) String() string {
	if m == nil {
		return "<nil>"
	}
