...
func (m *DomainDiscoverAPIActiveDiscoveryHost) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DomainDiscoverAPIActiveDiscoveryHost) validateNetworks(formats strfmt.Registry) error {
...
func (m *DomainDiscoverAPIActiveDiscoveryHost) contextValidateNetworks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DomainDiscoverAPIActiveDiscoveryHost) UnmarshalBinary(b []byte) error {
	var res DomainDiscoverAPIActiveDiscoveryHost
...
// String returns the JSON body of this domain discover API active discovery host. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *DomainDiscoverAPIActiveDiscoveryHost) String() string {
	if m == nil {
		return "<nil>"
	}
