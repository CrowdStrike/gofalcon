...
func (m *DeviceControlCreatePoliciesV1) validateResources(formats strfmt.Registry) error {
...
func (m *DeviceControlCreatePoliciesV1) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DeviceControlCreatePoliciesV1) UnmarshalBinary(b []byte) error {
	var res DeviceControlCreatePoliciesV1
...
// String returns the JSON body of this device control create policies v1. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *DeviceControlCreatePoliciesV1) String() string {
	if m == nil {
		return "<nil>"
	}
