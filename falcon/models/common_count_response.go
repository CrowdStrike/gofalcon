...
func (m *CommonCountResponse) validateMeta(formats strfmt.Registry) error {
...
func (m *CommonCountResponse) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
// String returns the JSON body of this common count response. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *CommonCountResponse) String() string {
	if m == nil {
		return "<nil>"
	}
