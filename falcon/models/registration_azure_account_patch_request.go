...
func (m *RegistrationAzureAccountPatchRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *RegistrationAzureAccountPatchRequest) validateResources(formats strfmt.Registry) error {
...
func (m *RegistrationAzureAccountPatchRequest) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RegistrationAzureAccountPatchRequest) UnmarshalBinary(b []byte) error {
	var res RegistrationAzureAccountPatchRequest
...
// String returns the JSON body of this registration azure account patch request. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *RegistrationAzureAccountPatchRequest) String() string {
	if m == nil {
		return "<nil>"
	}
