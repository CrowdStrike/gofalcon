...
// String returns the JSON body of this devicecontrolapi u s b custom notifications. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *DevicecontrolapiUSBCustomNotifications) String() string {
	if m == nil {
		return "<nil>"
	}
