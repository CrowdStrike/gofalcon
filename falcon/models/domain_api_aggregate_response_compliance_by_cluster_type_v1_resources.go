...
// String returns the JSON body of this domain API aggregate response compliance by cluster type v1 resources. It implements
// fmt.Stringer so that %v and %+v render the value instead of a pointer address.
func (m *DomainAPIAggregateResponseComplianceByClusterTypeV1Resources) String() string {
	if m == nil {
		return "<nil>"
	}
