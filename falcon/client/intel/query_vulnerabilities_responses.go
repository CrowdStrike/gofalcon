...
func (o *QueryVulnerabilitiesDefault) Error() string {
	return fmt.Sprintf("[GET /intel/queries/vulnerabilities/v1][%d] QueryVulnerabilities default  %+v", o._statusCode, o.Payload)
}
...
func (o *QueryVulnerabilitiesDefault) GetPayload() *models.MsaQueryResponse {
	return o.Payload
}
