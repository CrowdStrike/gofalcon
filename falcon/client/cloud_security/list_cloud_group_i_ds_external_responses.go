...
func (o *ListCloudGroupIDsExternalReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewListCloudGroupIDsExternalTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewListCloudGroupIDsExternalTooManyRequests() *ListCloudGroupIDsExternalTooManyRequests {
	return &ListCloudGroupIDsExternalTooManyRequests{}
}
...
func (o *ListCloudGroupIDsExternalTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /cloud-security/queries/cloud-groups/v1][%d] listCloudGroupIDsExternalTooManyRequests  %+v", 429, o.Payload)
}
...
func (o *ListCloudGroupIDsExternalTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
