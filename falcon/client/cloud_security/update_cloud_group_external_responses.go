...
func (o *UpdateCloudGroupExternalReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewUpdateCloudGroupExternalTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewUpdateCloudGroupExternalTooManyRequests() *UpdateCloudGroupExternalTooManyRequests {
	return &UpdateCloudGroupExternalTooManyRequests{}
}
...
func (o *UpdateCloudGroupExternalTooManyRequests) Error() string {
	return fmt.Sprintf("[PATCH /cloud-security/entities/cloud-groups/v1][%d] updateCloudGroupExternalTooManyRequests  %+v", 429, o.Payload)
}
...
func (o *UpdateCloudGroupExternalTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
