...
func (o *ListCloudGroupIDsExternalParams) WithLimit(limit *int64) *ListCloudGroupIDsExternalParams {
	o.SetLimit(limit)
	return o
}

// SetLimit adds the limit to the list cloud group i ds external params
func (o *ListCloudGroupIDsExternalParams) SetLimit(limit *int64) {
	o.Limit = limit
}

// WithOffset adds the offset to the list cloud group i ds external params
func (o *ListCloudGroupIDsExternalParams) WithOffset(offset *int64) *ListCloudGroupIDsExternalParams {
	o.SetOffset(offset)
	return o
}

// SetOffset adds the offset to the list cloud group i ds external params
func (o *ListCloudGroupIDsExternalParams) SetOffset(offset *int64) {
	o.Offset = offset
}
