...
func (o *QueryRuleGroupsOK) Error() string {
	...
	return fmt.Sprintf("[GET /filevantage/queries/rule-groups/v1][%d] queryRuleGroupsOK %s", 200, payload)
}
...
func (o *QueryRuleGroupsBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /filevantage/queries/rule-groups/v1][%d] queryRuleGroupsBadRequest %s", 400, payload)
}
...
func (o *QueryRuleGroupsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /filevantage/queries/rule-groups/v1][%d] queryRuleGroupsForbidden %s", 403, payload)
}
...
func (o *QueryRuleGroupsTooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /filevantage/queries/rule-groups/v1][%d] queryRuleGroupsTooManyRequests %s", 429, payload)
}
...
func (o *QueryRuleGroupsInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /filevantage/queries/rule-groups/v1][%d] queryRuleGroupsInternalServerError %s", 500, payload)
}
