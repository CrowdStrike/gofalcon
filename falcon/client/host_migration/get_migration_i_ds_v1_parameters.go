...
type GetMigrationIDsV1Params struct {
	...
	/* Filter.
	   ...
	   The filter expression that should be used to limit the results. Valid fields: name, id, migration_id, target_cid, status, migration_status, created_by, created_time
	*/
	Filter *string
