...
func (o *QueryRuleGroupsMixin0OK) Error() string {
	...
	return fmt.Sprintf("[GET /ioarules/queries/rule-groups/v1][%d] queryRuleGroupsMixin0OK %s", 200, payload)
}
...
func (o *QueryRuleGroupsMixin0Forbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /ioarules/queries/rule-groups/v1][%d] queryRuleGroupsMixin0Forbidden %s", 403, payload)
}
...
func (o *QueryRuleGroupsMixin0NotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /ioarules/queries/rule-groups/v1][%d] queryRuleGroupsMixin0NotFound %s", 404, payload)
}
...
func (o *QueryRuleGroupsMixin0TooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /ioarules/queries/rule-groups/v1][%d] queryRuleGroupsMixin0TooManyRequests %s", 429, payload)
}
...
func (o *QueryRuleGroupsMixin0InternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /ioarules/queries/rule-groups/v1][%d] queryRuleGroupsMixin0InternalServerError %s", 500, payload)
}
