...
func (a *Client) ReadRequestBody(params *ReadRequestBodyParams, opts ...ClientOption) (*ReadRequestBodyOK, error) {
	...
	if params == nil {
		params = NewReadRequestBodyParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "ReadRequestBody",
		Method:             "GET",
		PathPattern:        "/faas-gateway/entities/execution-request-body/v2",
		ProducesMediaTypes: []string{"text/csv", "text/plain", "application/octet-stream", "application/json"},
	...
	success, ok := result.(*ReadRequestBodyOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for ReadRequestBody: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
