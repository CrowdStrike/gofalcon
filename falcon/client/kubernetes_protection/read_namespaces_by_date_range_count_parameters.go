...
// NewReadNamespacesByDateRangeCountParams creates a new ReadNamespacesByDateRangeCountParams object,
...
func NewReadNamespacesByDateRangeCountParams() *ReadNamespacesByDateRangeCountParams {
	return &ReadNamespacesByDateRangeCountParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewReadNamespacesByDateRangeCountParamsWithTimeout creates a new ReadNamespacesByDateRangeCountParams object
...
// NewReadNamespacesByDateRangeCountParamsWithContext creates a new ReadNamespacesByDateRangeCountParams object
...
// NewReadNamespacesByDateRangeCountParamsWithHTTPClient creates a new ReadNamespacesByDateRangeCountParams object
...
func (o *ReadNamespacesByDateRangeCountParams) WithDefaults() *ReadNamespacesByDateRangeCountParams {
	o.SetDefaults()
	return o
}
...
func (o *ReadNamespacesByDateRangeCountParams) WithTimeout(timeout time.Duration) *ReadNamespacesByDateRangeCountParams {
...
func (o *ReadNamespacesByDateRangeCountParams) WithContext(ctx context.Context) *ReadNamespacesByDateRangeCountParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the read namespaces by date range count params
func (o *ReadNamespacesByDateRangeCountParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the read namespaces by date range count params
func (o *ReadNamespacesByDateRangeCountParams) WithHTTPClient(client *http.Client) *ReadNamespacesByDateRangeCountParams {
...
func (o *ReadNamespacesByDateRangeCountParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
