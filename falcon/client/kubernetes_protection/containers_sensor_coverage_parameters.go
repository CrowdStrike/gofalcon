...
// NewContainersSensorCoverageParams creates a new ContainersSensorCoverageParams object,
...
func NewContainersSensorCoverageParams() *ContainersSensorCoverageParams {
	return &ContainersSensorCoverageParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewContainersSensorCoverageParamsWithTimeout creates a new ContainersSensorCoverageParams object
...
// NewContainersSensorCoverageParamsWithContext creates a new ContainersSensorCoverageParams object
...
// NewContainersSensorCoverageParamsWithHTTPClient creates a new ContainersSensorCoverageParams object
...
func (o *ContainersSensorCoverageParams) WithDefaults() *ContainersSensorCoverageParams {
	o.SetDefaults()
	return o
}
...
func (o *ContainersSensorCoverageParams) WithTimeout(timeout time.Duration) *ContainersSensorCoverageParams {
...
func (o *ContainersSensorCoverageParams) WithContext(ctx context.Context) *ContainersSensorCoverageParams {
	o.SetContext(ctx)
	return o
}
...
func (o *ContainersSensorCoverageParams) WithHTTPClient(client *http.Client) *ContainersSensorCoverageParams {
...
func (o *ContainersSensorCoverageParams) WithFilter(filter *string) *ContainersSensorCoverageParams {
	o.SetFilter(filter)
	return o
}
...
func (o *ContainersSensorCoverageParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
