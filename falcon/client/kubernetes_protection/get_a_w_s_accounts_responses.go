...
func (o *GetAWSAccountsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 207:
		result := NewGetAWSAccountsMultiStatus()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /kubernetes-protection/entities/accounts/aws/v1] GetAWSAccounts", response, response.Code())
	}
}
...
func (o *GetAWSAccountsOK) Error() string {
	return fmt.Sprintf("[GET /kubernetes-protection/entities/accounts/aws/v1][%d] getAWSAccountsOK  %+v", 200, o.Payload)
}
...
func (o *GetAWSAccountsOK) GetPayload() *models.K8sregGetAWSAccountsResp {
	return o.Payload
}
...
// NewGetAWSAccountsMultiStatus creates a GetAWSAccountsMultiStatus with default headers values
func NewGetAWSAccountsMultiStatus() *GetAWSAccountsMultiStatus {
	return &GetAWSAccountsMultiStatus{}
}

/*
GetAWSAccountsMultiStatus describes a response with status code 207, with default header values.

Multi-Status
*/
type GetAWSAccountsMultiStatus struct {
...
// IsSuccess returns true when this get a w s accounts multi status response has a 2xx status code
func (o *GetAWSAccountsMultiStatus) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this get a w s accounts multi status response has a 3xx status code
func (o *GetAWSAccountsMultiStatus) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get a w s accounts multi status response has a 4xx status code
func (o *GetAWSAccountsMultiStatus) IsClientError() bool {
	return false
}

// IsServerError returns true when this get a w s accounts multi status response has a 5xx status code
func (o *GetAWSAccountsMultiStatus) IsServerError() bool {
	return false
}

// IsCode returns true when this get a w s accounts multi status response a status code equal to that given
func (o *GetAWSAccountsMultiStatus) IsCode(code int) bool {
	return code == 207
}

// Code gets the status code for the get a w s accounts multi status response
func (o *GetAWSAccountsMultiStatus) Code() int {
	return 207
}

func (o *GetAWSAccountsMultiStatus) Error() string {
	return fmt.Sprintf("[GET /kubernetes-protection/entities/accounts/aws/v1][%d] getAWSAccountsMultiStatus  %+v", 207, o.Payload)
}

func (o *GetAWSAccountsMultiStatus) String() string {
	return fmt.Sprintf("[GET /kubernetes-protection/entities/accounts/aws/v1][%d] getAWSAccountsMultiStatus  %+v", 207, o.Payload)
}

func (o *GetAWSAccountsMultiStatus) GetPayload() *models.K8sregGetAWSAccountsResp {
	return o.Payload
}

func (o *GetAWSAccountsMultiStatus) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *GetAWSAccountsBadRequest) Error() string {
	return fmt.Sprintf("[GET /kubernetes-protection/entities/accounts/aws/v1][%d] getAWSAccountsBadRequest  %+v", 400, o.Payload)
}
...
func (o *GetAWSAccountsBadRequest) GetPayload() *models.K8sregGetAWSAccountsResp {
	return o.Payload
}
...
func (o *GetAWSAccountsForbidden) Error() string {
	return fmt.Sprintf("[GET /kubernetes-protection/entities/accounts/aws/v1][%d] getAWSAccountsForbidden  %+v", 403, o.Payload)
}
...
func (o *GetAWSAccountsTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /kubernetes-protection/entities/accounts/aws/v1][%d] getAWSAccountsTooManyRequests  %+v", 429, o.Payload)
}
...
func (o *GetAWSAccountsInternalServerError) Error() string {
	return fmt.Sprintf("[GET /kubernetes-protection/entities/accounts/aws/v1][%d] getAWSAccountsInternalServerError  %+v", 500, o.Payload)
}
...
func (o *GetAWSAccountsInternalServerError) GetPayload() *models.K8sregGetAWSAccountsResp {
	return o.Payload
}
