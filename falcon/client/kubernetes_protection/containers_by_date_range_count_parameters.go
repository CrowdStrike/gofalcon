...
// NewContainersByDateRangeCountParams creates a new ContainersByDateRangeCountParams object,
...
func NewContainersByDateRangeCountParams() *ContainersByDateRangeCountParams {
	return &ContainersByDateRangeCountParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewContainersByDateRangeCountParamsWithTimeout creates a new ContainersByDateRangeCountParams object
...
// NewContainersByDateRangeCountParamsWithContext creates a new ContainersByDateRangeCountParams object
...
// NewContainersByDateRangeCountParamsWithHTTPClient creates a new ContainersByDateRangeCountParams object
...
func (o *ContainersByDateRangeCountParams) WithDefaults() *ContainersByDateRangeCountParams {
	o.SetDefaults()
	return o
}
...
func (o *ContainersByDateRangeCountParams) WithTimeout(timeout time.Duration) *ContainersByDateRangeCountParams {
...
func (o *ContainersByDateRangeCountParams) WithContext(ctx context.Context) *ContainersByDateRangeCountParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the containers by date range count params
func (o *ContainersByDateRangeCountParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the containers by date range count params
func (o *ContainersByDateRangeCountParams) WithHTTPClient(client *http.Client) *ContainersByDateRangeCountParams {
...
func (o *ContainersByDateRangeCountParams) WithFilter(filter *string) *ContainersByDateRangeCountParams {
	o.SetFilter(filter)
	return o
}
...
func (o *ContainersByDateRangeCountParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
