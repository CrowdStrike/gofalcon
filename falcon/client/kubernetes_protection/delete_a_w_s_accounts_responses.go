...
func (o *DeleteAWSAccountsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 207:
		result := NewDeleteAWSAccountsMultiStatus()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[DELETE /kubernetes-protection/entities/accounts/aws/v1] DeleteAWSAccounts", response, response.Code())
	}
}
...
func (o *DeleteAWSAccountsOK) Error() string {
	return fmt.Sprintf("[DELETE /kubernetes-protection/entities/accounts/aws/v1][%d] deleteAWSAccountsOK  %+v", 200, o.Payload)
}
...
func (o *DeleteAWSAccountsOK) GetPayload() *models.MsaMetaInfo {
	return o.Payload
}
...
// NewDeleteAWSAccountsMultiStatus creates a DeleteAWSAccountsMultiStatus with default headers values
func NewDeleteAWSAccountsMultiStatus() *DeleteAWSAccountsMultiStatus {
	return &DeleteAWSAccountsMultiStatus{}
}

/*
DeleteAWSAccountsMultiStatus describes a response with status code 207, with default header values.

Multi-Status
*/
type DeleteAWSAccountsMultiStatus struct {
...
// IsSuccess returns true when this delete a w s accounts multi status response has a 2xx status code
func (o *DeleteAWSAccountsMultiStatus) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this delete a w s accounts multi status response has a 3xx status code
func (o *DeleteAWSAccountsMultiStatus) IsRedirect() bool {
	return false
}

// IsClientError returns true when this delete a w s accounts multi status response has a 4xx status code
func (o *DeleteAWSAccountsMultiStatus) IsClientError() bool {
	return false
}

// IsServerError returns true when this delete a w s accounts multi status response has a 5xx status code
func (o *DeleteAWSAccountsMultiStatus) IsServerError() bool {
	return false
}

// IsCode returns true when this delete a w s accounts multi status response a status code equal to that given
func (o *DeleteAWSAccountsMultiStatus) IsCode(code int) bool {
	return code == 207
}

// Code gets the status code for the delete a w s accounts multi status response
func (o *DeleteAWSAccountsMultiStatus) Code() int {
	return 207
}

func (o *DeleteAWSAccountsMultiStatus) Error() string {
	return fmt.Sprintf("[DELETE /kubernetes-protection/entities/accounts/aws/v1][%d] deleteAWSAccountsMultiStatus  %+v", 207, o.Payload)
}

func (o *DeleteAWSAccountsMultiStatus) String() string {
	return fmt.Sprintf("[DELETE /kubernetes-protection/entities/accounts/aws/v1][%d] deleteAWSAccountsMultiStatus  %+v", 207, o.Payload)
}

func (o *DeleteAWSAccountsMultiStatus) GetPayload() *models.MsaMetaInfo {
	return o.Payload
}

func (o *DeleteAWSAccountsMultiStatus) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *DeleteAWSAccountsBadRequest) Error() string {
	return fmt.Sprintf("[DELETE /kubernetes-protection/entities/accounts/aws/v1][%d] deleteAWSAccountsBadRequest  %+v", 400, o.Payload)
}
...
func (o *DeleteAWSAccountsBadRequest) GetPayload() *models.MsaMetaInfo {
	return o.Payload
}
...
func (o *DeleteAWSAccountsForbidden) Error() string {
	return fmt.Sprintf("[DELETE /kubernetes-protection/entities/accounts/aws/v1][%d] deleteAWSAccountsForbidden  %+v", 403, o.Payload)
}
...
func (o *DeleteAWSAccountsTooManyRequests) Error() string {
	return fmt.Sprintf("[DELETE /kubernetes-protection/entities/accounts/aws/v1][%d] deleteAWSAccountsTooManyRequests  %+v", 429, o.Payload)
}
...
func (o *DeleteAWSAccountsInternalServerError) Error() string {
	return fmt.Sprintf("[DELETE /kubernetes-protection/entities/accounts/aws/v1][%d] deleteAWSAccountsInternalServerError  %+v", 500, o.Payload)
}
...
func (o *DeleteAWSAccountsInternalServerError) GetPayload() *models.MsaMetaInfo {
	return o.Payload
}
