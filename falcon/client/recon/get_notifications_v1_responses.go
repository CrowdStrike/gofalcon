...
func (o *GetNotificationsV1Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		result := NewGetNotificationsV1Default(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
// NewGetNotificationsV1Default creates a GetNotificationsV1Default with default headers values
func NewGetNotificationsV1Default(code int) *GetNotificationsV1Default {
	return &GetNotificationsV1Default{
		_statusCode: code,
	}
}

/*
GetNotificationsV1Default describes a response with status code -1, with default header values.

OK
*/
type GetNotificationsV1Default struct {
	_statusCode int

	Payload *models.DomainNotificationEntitiesResponseV1
}

// Code gets the status code for the get notifications v1 default response
func (o *GetNotificationsV1Default) Code() int {
	return o._statusCode
}

// IsSuccess returns true when this get notifications v1 default response has a 2xx status code
func (o *GetNotificationsV1Default) IsSuccess() bool {
	return o._statusCode/100 == 2
}

// IsRedirect returns true when this get notifications v1 default response has a 3xx status code
func (o *GetNotificationsV1Default) IsRedirect() bool {
	return o._statusCode/100 == 3
}

// IsClientError returns true when this get notifications v1 default response has a 4xx status code
func (o *GetNotificationsV1Default) IsClientError() bool {
	return o._statusCode/100 == 4
}

// IsServerError returns true when this get notifications v1 default response has a 5xx status code
func (o *GetNotificationsV1Default) IsServerError() bool {
	return o._statusCode/100 == 5
}

// IsCode returns true when this get notifications v1 default response a status code equal to that given
func (o *GetNotificationsV1Default) IsCode(code int) bool {
	return o._statusCode == code
}

func (o *GetNotificationsV1Default) Error() string {
	return fmt.Sprintf("[GET /recon/entities/notifications/v1][%d] GetNotificationsV1 default  %+v", o._statusCode, o.Payload)
}

func (o *GetNotificationsV1Default) String() string {
	return fmt.Sprintf("[GET /recon/entities/notifications/v1][%d] GetNotificationsV1 default  %+v", o._statusCode, o.Payload)
}

func (o *GetNotificationsV1Default) GetPayload() *models.DomainNotificationEntitiesResponseV1 {
	return o.Payload
}

func (o *GetNotificationsV1Default) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
