...
func (o *GetActionsV1Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		result := NewGetActionsV1Default(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
// NewGetActionsV1Default creates a GetActionsV1Default with default headers values
func NewGetActionsV1Default(code int) *GetActionsV1Default {
	return &GetActionsV1Default{
		_statusCode: code,
	}
}
...
OK
*/
type GetActionsV1Default struct {
	_statusCode int

	Payload *models.DomainActionEntitiesResponseV1
}

// IsSuccess returns true when this get actions v1 default response has a 2xx status code
func (o *GetActionsV1Default) IsSuccess() bool {
	return o._statusCode/100 == 2
}

// IsRedirect returns true when this get actions v1 default response has a 3xx status code
func (o *GetActionsV1Default) IsRedirect() bool {
	return o._statusCode/100 == 3
}

// IsClientError returns true when this get actions v1 default response has a 4xx status code
func (o *GetActionsV1Default) IsClientError() bool {
	return o._statusCode/100 == 4
}

// IsServerError returns true when this get actions v1 default response has a 5xx status code
func (o *GetActionsV1Default) IsServerError() bool {
	return o._statusCode/100 == 5
}

// IsCode returns true when this get actions v1 default response a status code equal to that given
func (o *GetActionsV1Default) IsCode(code int) bool {
	return o._statusCode == code
}

// Code gets the status code for the get actions v1 default response
func (o *GetActionsV1Default) Code() int {
	return o._statusCode
}

func (o *GetActionsV1Default) Error() string {
	return fmt.Sprintf("[GET /recon/entities/actions/v1][%d] GetActionsV1 default  %+v", o._statusCode, o.Payload)
}

func (o *GetActionsV1Default) String() string {
	return fmt.Sprintf("[GET /recon/entities/actions/v1][%d] GetActionsV1 default  %+v", o._statusCode, o.Payload)
}

func (o *GetActionsV1Default) GetPayload() *models.DomainActionEntitiesResponseV1 {
	return o.Payload
}

func (o *GetActionsV1Default) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
