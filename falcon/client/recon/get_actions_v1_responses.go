...
func (o *GetActionsV1OK) Error() string {
	...
	return fmt.Sprintf("[GET /recon/entities/actions/v1][%d] getActionsV1OK %s", 200, payload)
}
...
func (o *GetActionsV1BadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /recon/entities/actions/v1][%d] getActionsV1BadRequest %s", 400, payload)
}
...
func (o *GetActionsV1Unauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /recon/entities/actions/v1][%d] getActionsV1Unauthorized %s", 401, payload)
}
...
func (o *GetActionsV1Forbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /recon/entities/actions/v1][%d] getActionsV1Forbidden %s", 403, payload)
}
...
func (o *GetActionsV1TooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /recon/entities/actions/v1][%d] getActionsV1TooManyRequests %s", 429, payload)
}
...
func (o *GetActionsV1InternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /recon/entities/actions/v1][%d] getActionsV1InternalServerError %s", 500, payload)
}
