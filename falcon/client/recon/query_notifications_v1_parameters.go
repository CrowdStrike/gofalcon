...
type QueryNotificationsV1Params struct {
	...
	/* Filter.
	   ...
	   FQL query to filter notifications by. Possible filter properties are: [id cid user_uuid status rule_id rule_name rule_topic rule_priority item_type item_site typosquatting.id typosquatting.unicode_format typosquatting.punycode_format typosquatting.parent_domain.id typosquatting.parent_domain.unicode_format typosquatting.parent_domain.punycode_format typosquatting.base_domain.id typosquatting.base_domain.unicode_format typosquatting.base_domain.punycode_format typosquatting.base_domain.is_registered typosquatting.base_domain.whois.registrar.name typosquatting.base_domain.whois.registrar.status typosquatting.base_domain.whois.registrant.email typosquatting.base_domain.whois.registrant.name typosquatting.base_domain.whois.registrant.org typosquatting.base_domain.whois.name_servers typosquatting.base_domain.url_scan.scan_id typosquatting.base_domain.url_scan.status typosquatting.base_domain.url_scan.captured_at created_date updated_date assigned_to_uuid risk_score_label breach_summary.credential_statuses breach_summary.is_retroactively_deduped]
	*/
	Filter *string
