...
/*
AggregateNotificationsExposedDataRecordsV1 gets notification exposed data record aggregates as specified via JSON in request body the valid aggregation fields are cid notification id notification group id created date rule id rule name rule topic source category site author file name credential status bot operating system hardware id bot bot id
*/
