...
func (o *GetExportJobsV1Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		result := NewGetExportJobsV1Default(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
// NewGetExportJobsV1Default creates a GetExportJobsV1Default with default headers values
func NewGetExportJobsV1Default(code int) *GetExportJobsV1Default {
	return &GetExportJobsV1Default{
		_statusCode: code,
	}
}

/*
GetExportJobsV1Default describes a response with status code -1, with default header values.

OK
*/
type GetExportJobsV1Default struct {
	_statusCode int

	Payload *models.DomainExportJobEntitiesResponseV1
}

// Code gets the status code for the get export jobs v1 default response
func (o *GetExportJobsV1Default) Code() int {
	return o._statusCode
}

// IsSuccess returns true when this get export jobs v1 default response has a 2xx status code
func (o *GetExportJobsV1Default) IsSuccess() bool {
	return o._statusCode/100 == 2
}

// IsRedirect returns true when this get export jobs v1 default response has a 3xx status code
func (o *GetExportJobsV1Default) IsRedirect() bool {
	return o._statusCode/100 == 3
}

// IsClientError returns true when this get export jobs v1 default response has a 4xx status code
func (o *GetExportJobsV1Default) IsClientError() bool {
	return o._statusCode/100 == 4
}

// IsServerError returns true when this get export jobs v1 default response has a 5xx status code
func (o *GetExportJobsV1Default) IsServerError() bool {
	return o._statusCode/100 == 5
}

// IsCode returns true when this get export jobs v1 default response a status code equal to that given
func (o *GetExportJobsV1Default) IsCode(code int) bool {
	return o._statusCode == code
}

func (o *GetExportJobsV1Default) Error() string {
	return fmt.Sprintf("[GET /recon/entities/exports/v1][%d] GetExportJobsV1 default  %+v", o._statusCode, o.Payload)
}

func (o *GetExportJobsV1Default) String() string {
	return fmt.Sprintf("[GET /recon/entities/exports/v1][%d] GetExportJobsV1 default  %+v", o._statusCode, o.Payload)
}

func (o *GetExportJobsV1Default) GetPayload() *models.DomainExportJobEntitiesResponseV1 {
	return o.Payload
}

func (o *GetExportJobsV1Default) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
