...
func (o *QueryRulesV1OK) Error() string {
	...
	return fmt.Sprintf("[GET /recon/queries/rules/v1][%d] queryRulesV1OK %s", 200, payload)
}
...
func (o *QueryRulesV1BadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /recon/queries/rules/v1][%d] queryRulesV1BadRequest %s", 400, payload)
}
...
func (o *QueryRulesV1Unauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /recon/queries/rules/v1][%d] queryRulesV1Unauthorized %s", 401, payload)
}
...
func (o *QueryRulesV1Forbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /recon/queries/rules/v1][%d] queryRulesV1Forbidden %s", 403, payload)
}
...
func (o *QueryRulesV1TooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /recon/queries/rules/v1][%d] queryRulesV1TooManyRequests %s", 429, payload)
}
...
func (o *QueryRulesV1InternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /recon/queries/rules/v1][%d] queryRulesV1InternalServerError %s", 500, payload)
}
