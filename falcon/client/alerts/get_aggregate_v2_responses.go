...
func (o *GetAggregateV2OK) Error() string {
	...
	return fmt.Sprintf("[POST /alerts/aggregates/alerts/v2][%d] getAggregateV2OK %s", 200, payload)
}
...
func (o *GetAggregateV2BadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /alerts/aggregates/alerts/v2][%d] getAggregateV2BadRequest %s", 400, payload)
}
...
func (o *GetAggregateV2Forbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /alerts/aggregates/alerts/v2][%d] getAggregateV2Forbidden %s", 403, payload)
}
...
func (o *GetAggregateV2TooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /alerts/aggregates/alerts/v2][%d] getAggregateV2TooManyRequests %s", 429, payload)
}
...
func (o *GetAggregateV2InternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /alerts/aggregates/alerts/v2][%d] getAggregateV2InternalServerError %s", 500, payload)
}
