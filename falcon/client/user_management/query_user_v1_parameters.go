...
type QueryUserV1Params struct {
	...
	/* Filter.
	   ...
	   Filter using a query in Falcon Query Language (FQL). Supported filters: assigned_cids, cid, direct_assigned_cids, factors, first_name, has_temporary_roles, last_name, name, non_ancestor_assigned_cids, status, temporarily_assigned_cids, uid, uuid
	*/
	Filter *string
