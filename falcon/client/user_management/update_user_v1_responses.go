...
func (o *UpdateUserV1OK) Error() string {
	...
	return fmt.Sprintf("[PATCH /user-management/entities/users/v1][%d] updateUserV1OK %s", 200, payload)
}
...
func (o *UpdateUserV1BadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /user-management/entities/users/v1][%d] updateUserV1BadRequest %s", 400, payload)
}
...
func (o *UpdateUserV1Forbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /user-management/entities/users/v1][%d] updateUserV1Forbidden %s", 403, payload)
}
...
func (o *UpdateUserV1TooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /user-management/entities/users/v1][%d] updateUserV1TooManyRequests %s", 429, payload)
}
...
func (o *UpdateUserV1InternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /user-management/entities/users/v1][%d] updateUserV1InternalServerError %s", 500, payload)
}
