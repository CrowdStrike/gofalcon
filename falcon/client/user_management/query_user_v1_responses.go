...
func (o *QueryUserV1OK) Error() string {
	...
	return fmt.Sprintf("[GET /user-management/queries/users/v1][%d] queryUserV1OK %s", 200, payload)
}
...
func (o *QueryUserV1BadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /user-management/queries/users/v1][%d] queryUserV1BadRequest %s", 400, payload)
}
...
func (o *QueryUserV1Forbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /user-management/queries/users/v1][%d] queryUserV1Forbidden %s", 403, payload)
}
...
func (o *QueryUserV1TooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /user-management/queries/users/v1][%d] queryUserV1TooManyRequests %s", 429, payload)
}
...
func (o *QueryUserV1InternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /user-management/queries/users/v1][%d] queryUserV1InternalServerError %s", 500, payload)
}
