...
// WithXCSUSERUUID adds the xCSUSERUUID to the get scanners params
func (o *GetScannersParams) WithXCSUSERUUID(xCSUSERUUID *string) *GetScannersParams {
	o.SetXCSUSERUUID(xCSUSERUUID)
	return o
}

// SetXCSUSERUUID adds the xCSUSERUuid to the get scanners params
func (o *GetScannersParams) SetXCSUSERUUID(xCSUSERUUID *string) {
	o.XCSUSERUUID = xCSUSERUUID
}

// WithIds adds the ids to the get scanners params
func (o *GetScannersParams) WithIds(ids []string) *GetScannersParams {
	o.SetIds(ids)
	return o
}

// SetIds adds the ids to the get scanners params
func (o *GetScannersParams) SetIds(ids []string) {
	o.Ids = ids
}
...
// bindParamGetScanners binds the parameter ids
func (o *GetScannersParams) bindParamIds(formats strfmt.Registry) []string {
	idsIR := o.Ids
