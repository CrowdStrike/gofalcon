...
func (o *GetDeploymentsExternalV1OK) Error() string {
	...
	return fmt.Sprintf("[GET /deployment-coordinator/entities/deployments/external/v1][%d] getDeploymentsExternalV1OK %s", 200, payload)
}
...
func (o *GetDeploymentsExternalV1BadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /deployment-coordinator/entities/deployments/external/v1][%d] getDeploymentsExternalV1BadRequest %s", 400, payload)
}
...
func (o *GetDeploymentsExternalV1Forbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /deployment-coordinator/entities/deployments/external/v1][%d] getDeploymentsExternalV1Forbidden %s", 403, payload)
}
...
func (o *GetDeploymentsExternalV1NotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /deployment-coordinator/entities/deployments/external/v1][%d] getDeploymentsExternalV1NotFound %s", 404, payload)
}
...
func (o *GetDeploymentsExternalV1TooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /deployment-coordinator/entities/deployments/external/v1][%d] getDeploymentsExternalV1TooManyRequests %s", 429, payload)
}
...
func (o *GetDeploymentsExternalV1InternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /deployment-coordinator/entities/deployments/external/v1][%d] getDeploymentsExternalV1InternalServerError %s", 500, payload)
}
