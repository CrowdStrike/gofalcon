...
// WithXCSADBNAMESPACE adds the xCSADBNAMESPACE to the list objects params
func (o *ListObjectsParams) WithXCSADBNAMESPACE(xCSADBNAMESPACE string) *ListObjectsParams {
	o.SetXCSADBNAMESPACE(xCSADBNAMESPACE)
	return o
}

// SetXCSADBNAMESPACE adds the xCSADBNAMESPACE to the list objects params
func (o *ListObjectsParams) SetXCSADBNAMESPACE(xCSADBNAMESPACE string) {
	o.XCSADBNAMESPACE = xCSADBNAMESPACE
}

// WithXCSAPPID adds the xCSAPPID to the list objects params
func (o *ListObjectsParams) WithXCSAPPID(xCSAPPID *string) *ListObjectsParams {
	o.SetXCSAPPID(xCSAPPID)
	return o
}

// SetXCSAPPID adds the xCSAPPId to the list objects params
func (o *ListObjectsParams) SetXCSAPPID(xCSAPPID *string) {
	o.XCSAPPID = xCSAPPID
}
