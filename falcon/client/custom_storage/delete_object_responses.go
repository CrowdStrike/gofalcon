...
func (o *DeleteObjectReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 429:
		...
		return nil, result
	case 500:
		result := NewDeleteObjectInternalServerError()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDeleteObjectInternalServerError creates a DeleteObjectInternalServerError with default headers values
func NewDeleteObjectInternalServerError() *DeleteObjectInternalServerError {
	return &DeleteObjectInternalServerError{}
}

/*
DeleteObjectInternalServerError describes a response with status code 500, with default header values.
...
// IsSuccess returns true when this delete object internal server error response has a 2xx status code
func (o *DeleteObjectInternalServerError) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this delete object internal server error response has a 3xx status code
func (o *DeleteObjectInternalServerError) IsRedirect() bool {
	return false
}

// IsClientError returns true when this delete object internal server error response has a 4xx status code
func (o *DeleteObjectInternalServerError) IsClientError() bool {
	return false
}

// IsServerError returns true when this delete object internal server error response has a 5xx status code
func (o *DeleteObjectInternalServerError) IsServerError() bool {
	return true
}

// IsCode returns true when this delete object internal server error response a status code equal to that given
func (o *DeleteObjectInternalServerError) IsCode(code int) bool {
	return code == 500
}

// Code gets the status code for the delete object internal server error response
func (o *DeleteObjectInternalServerError) Code() int {
	return 500
}
...
func (o *DeleteObjectInternalServerError) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
