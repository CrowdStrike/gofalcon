...
// WithXCSCUSTID adds the xCSCUSTID to the create rule params
func (o *CreateRuleParams) WithXCSCUSTID(xCSCUSTID string) *CreateRuleParams {
	o.SetXCSCUSTID(xCSCUSTID)
	return o
}

// SetXCSCUSTID adds the xCSCUSTId to the create rule params
func (o *CreateRuleParams) SetXCSCUSTID(xCSCUSTID string) {
	o.XCSCUSTID = xCSCUSTID
}

// WithXCSUSERUUID adds the xCSUSERUUID to the create rule params
func (o *CreateRuleParams) WithXCSUSERUUID(xCSUSERUUID string) *CreateRuleParams {
	o.SetXCSUSERUUID(xCSUSERUUID)
	return o
}

// SetXCSUSERUUID adds the xCSUSERUuid to the create rule params
func (o *CreateRuleParams) SetXCSUSERUUID(xCSUSERUUID string) {
	o.XCSUSERUUID = xCSUSERUUID
}

// WithBody adds the body to the create rule params
func (o *CreateRuleParams) WithBody(body *models.CommonCreateRuleRequest) *CreateRuleParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create rule params
func (o *CreateRuleParams) SetBody(body *models.CommonCreateRuleRequest) {
	o.Body = body
}
