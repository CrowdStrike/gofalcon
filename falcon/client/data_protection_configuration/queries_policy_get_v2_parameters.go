...
type QueriesPolicyGetV2Params struct {
	...
	/* Filter.
	   ...
	   Filter results by specific attributes , allowed attributes are [modified_by properties.browsers_without_active_extension properties.be_upload_timeout_duration_seconds properties.be_paste_timeout_duration_milliseconds properties.evidence_storage_max_size name precedence is_default modified_at properties.enable_content_inspection properties.enable_clipboard_inspection properties.custom_allow_notification properties.custom_block_notification properties.min_confidence_level properties.unsupported_browsers_action properties.similarity_detection properties.enable_network_inspection properties.be_exclude_domains properties.besplash_message_source properties.be_paste_timeout_response properties.be_paste_clipboard_min_size is_enabled properties.enable_context_inspection properties.evidence_duplication_enabled_default properties.besplash_custom_message properties.be_paste_clipboard_max_size properties.max_file_size_to_inspect properties.block_all_data_access properties.block_notifications properties.network_inspection_files_exceeding_size_limit properties.be_paste_clipboard_min_size_unit properties.be_paste_clipboard_max_size_unit properties.be_paste_clipboard_over_size_behaviour_block properties.inspection_depth properties.evidence_encrypted_enabled properties.classifications created_at created_by properties.similarity_threshold properties.allow_notifications properties.besplash_enabled properties.be_upload_timeout_response properties.evidence_storage_free_disk_perc description properties.max_file_size_to_inspect_unit properties.enable_end_user_notifications_unsupported_browser properties.evidence_download_enabled]
	*/
	Filter *string
