...
type QueriesPolicyGetV2Params struct {
	...
	/* Filter.
	   ...
	   Filter results by specific attributes , allowed attributes are [precedence properties.enable_content_inspection properties.inspection_depth properties.unsupported_browsers_action properties.enable_network_inspection properties.network_inspection_files_exceeding_size_limit properties.be_exclude_domains properties.be_paste_clipboard_min_size properties.enable_clipboard_inspection properties.evidence_duplication_enabled_default properties.besplash_custom_message properties.be_paste_clipboard_over_size_behaviour_block properties.evidence_storage_free_disk_perc properties.evidence_storage_max_size properties.max_file_size_to_inspect description is_default properties.besplash_enabled properties.be_paste_timeout_duration_milliseconds properties.min_confidence_level properties.max_file_size_to_inspect_unit properties.block_all_data_access properties.similarity_detection properties.custom_block_notification properties.evidence_encrypted_enabled properties.be_upload_timeout_response name is_enabled created_at properties.similarity_threshold properties.enable_end_user_notifications_unsupported_browser properties.block_notifications properties.custom_allow_notification properties.evidence_download_enabled modified_at properties.enable_context_inspection properties.classifications properties.besplash_message_source properties.be_paste_clipboard_min_size_unit properties.be_paste_clipboard_max_size_unit created_by properties.browsers_without_active_extension properties.be_paste_timeout_response modified_by properties.allow_notifications properties.be_upload_timeout_duration_seconds properties.be_paste_clipboard_max_size]
	*/
	Filter *string
