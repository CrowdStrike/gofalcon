...
type QueriesPolicyGetV2Params struct {
	...
	/* Filter.
	   ...
	   Filter results by specific attributes , allowed attributes are [properties.evidence_storage_max_size properties.euj_dialog_timeout properties.max_file_size_to_inspect_unit properties.classifications properties.be_paste_timeout_response properties.be_paste_clipboard_min_size_unit properties.be_paste_clipboard_max_size properties.screen_capture_duration_post_event properties.screen_capture_duration_pre_event name modified_by properties.allow_notifications properties.block_notifications properties.evidence_download_enabled properties.enable_screen_capture precedence properties.block_all_data_access properties.enable_clipboard_inspection properties.enable_network_inspection properties.besplash_message_source created_at modified_at properties.custom_allow_notification properties.be_exclude_domains properties.enable_ocr is_default created_by properties.enable_content_inspection properties.enable_end_user_notifications_unsupported_browser properties.be_upload_timeout_response properties.enable_context_inspection properties.browsers_without_active_extension properties.similarity_detection properties.evidence_encrypted_enabled properties.besplash_enabled properties.besplash_custom_message properties.be_paste_clipboard_min_size properties.max_file_size_to_inspect description is_enabled properties.min_confidence_level properties.inspection_depth properties.enable_clipboard_web_origin properties.network_inspection_files_exceeding_size_limit properties.be_upload_timeout_duration_seconds properties.be_paste_timeout_duration_milliseconds properties.similarity_threshold properties.custom_block_notification properties.evidence_duplication_enabled_default properties.be_paste_clipboard_max_size_unit properties.be_paste_clipboard_over_size_behaviour_block properties.evidence_storage_free_disk_perc]
	*/
	Filter *string
	...
	*/
	...
	/* Sort.
	   ...
	   The property to sort by, allowed fields are :[created_at modified_at name precedence]
	*/
	Sort *string
