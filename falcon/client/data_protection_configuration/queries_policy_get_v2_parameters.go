...
type QueriesPolicyGetV2Params struct {
	...
	/* Filter.
	   ...
	   Filter results by specific attributes , allowed attributes are [precedence properties.custom_block_notification properties.be_exclude_domains properties.be_paste_clipboard_min_size_unit properties.be_paste_clipboard_over_size_behaviour_block properties.enable_content_inspection properties.similarity_threshold properties.evidence_duplication_enabled_default description created_at properties.allow_notifications properties.evidence_encrypted_enabled properties.classifications properties.be_upload_timeout_response properties.max_file_size_to_inspect name is_default properties.block_all_data_access properties.similarity_detection properties.enable_end_user_notifications_unsupported_browser properties.custom_allow_notification properties.enable_network_inspection properties.besplash_custom_message created_by modified_by properties.enable_context_inspection properties.min_confidence_level properties.enable_clipboard_inspection properties.block_notifications properties.evidence_download_enabled properties.network_inspection_files_exceeding_size_limit is_enabled properties.max_file_size_to_inspect_unit properties.be_upload_timeout_duration_seconds properties.be_paste_timeout_duration_milliseconds properties.be_paste_clipboard_max_size modified_at properties.browsers_without_active_extension properties.unsupported_browsers_action properties.be_paste_timeout_response properties.be_paste_clipboard_max_size_unit properties.evidence_storage_free_disk_perc properties.evidence_storage_max_size properties.inspection_depth properties.besplash_enabled properties.besplash_message_source properties.be_paste_clipboard_min_size]
	*/
	Filter *string
