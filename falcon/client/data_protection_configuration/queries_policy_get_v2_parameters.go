...
type QueriesPolicyGetV2Params struct {
	...
	/* Filter.
	   ...
	   Filter results by specific attributes , allowed attributes are [name properties.enable_end_user_notifications_unsupported_browser properties.block_notifications properties.evidence_encrypted_enabled properties.be_paste_timeout_duration_milliseconds properties.be_paste_clipboard_max_size properties.be_paste_clipboard_over_size_behaviour_block description precedence modified_at properties.enable_context_inspection properties.inspection_depth properties.be_paste_clipboard_min_size_unit is_enabled properties.enable_content_inspection properties.browsers_without_active_extension properties.block_all_data_access properties.similarity_threshold properties.enable_clipboard_web_origin properties.custom_allow_notification properties.evidence_download_enabled properties.similarity_detection properties.enable_network_inspection properties.network_inspection_files_exceeding_size_limit properties.be_exclude_domains properties.besplash_message_source properties.be_paste_clipboard_min_size properties.max_file_size_to_inspect properties.screen_capture_duration_pre_event is_default properties.min_confidence_level properties.besplash_enabled properties.besplash_custom_message properties.be_upload_timeout_response properties.evidence_storage_free_disk_perc properties.screen_capture_duration_post_event created_at modified_by properties.max_file_size_to_inspect_unit properties.enable_screen_capture properties.enable_ocr properties.network_inspection_exclude_list_v2 created_by properties.enable_clipboard_inspection properties.allow_notifications properties.classifications properties.be_upload_timeout_duration_seconds properties.be_paste_clipboard_max_size_unit properties.evidence_storage_max_size properties.euj_dialog_timeout properties.custom_block_notification properties.evidence_duplication_enabled_default properties.be_paste_timeout_response properties.enable_print_monitor]
	*/
	Filter *string
