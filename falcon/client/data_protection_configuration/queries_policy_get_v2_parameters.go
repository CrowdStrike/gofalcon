...
type QueriesPolicyGetV2Params struct {
	...
	*/
	...
	/* Sort.
	   ...
	   The property to sort by, allowed fields are :[modified_at name precedence created_at]
	*/
	Sort *string
