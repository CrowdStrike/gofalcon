...
type QueriesPolicyGetV2Params struct {
	...
	/* Filter.
	   ...
	   Filter results by specific attributes , allowed attributes are [created_at properties.enable_context_inspection properties.inspection_depth properties.unsupported_browsers_action properties.similarity_detection properties.evidence_download_enabled properties.besplash_enabled is_default properties.similarity_threshold properties.evidence_duplication_enabled_default properties.network_inspection_files_exceeding_size_limit properties.besplash_message_source properties.be_paste_clipboard_min_size properties.be_paste_clipboard_max_size_unit properties.evidence_storage_free_disk_perc properties.block_notifications properties.be_paste_clipboard_max_size properties.max_file_size_to_inspect properties.min_confidence_level properties.be_upload_timeout_response properties.be_paste_clipboard_over_size_behaviour_block properties.evidence_storage_max_size precedence properties.classifications properties.be_upload_timeout_duration_seconds properties.be_paste_timeout_response created_by properties.enable_content_inspection properties.browsers_without_active_extension properties.custom_block_notification properties.enable_network_inspection description is_enabled modified_at properties.enable_end_user_notifications_unsupported_browser properties.allow_notifications properties.custom_allow_notification properties.be_paste_clipboard_min_size_unit modified_by properties.max_file_size_to_inspect_unit properties.block_all_data_access properties.enable_clipboard_inspection properties.evidence_encrypted_enabled properties.be_exclude_domains properties.besplash_custom_message properties.be_paste_timeout_duration_milliseconds name]
	*/
	Filter *string
