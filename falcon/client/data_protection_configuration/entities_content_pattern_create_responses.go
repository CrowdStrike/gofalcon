...
func (o *EntitiesContentPatternCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 403:
		...
		return nil, result
	case 409:
		result := NewEntitiesContentPatternCreateConflict()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewEntitiesContentPatternCreateConflict creates a EntitiesContentPatternCreateConflict with default headers values
func NewEntitiesContentPatternCreateConflict() *EntitiesContentPatternCreateConflict {
	return &EntitiesContentPatternCreateConflict{}
}

/*
EntitiesContentPatternCreateConflict describes a response with status code 409, with default header values.

Conflict
*/
type EntitiesContentPatternCreateConflict struct {
...
// IsSuccess returns true when this entities content pattern create conflict response has a 2xx status code
func (o *EntitiesContentPatternCreateConflict) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this entities content pattern create conflict response has a 3xx status code
func (o *EntitiesContentPatternCreateConflict) IsRedirect() bool {
	return false
}

// IsClientError returns true when this entities content pattern create conflict response has a 4xx status code
func (o *EntitiesContentPatternCreateConflict) IsClientError() bool {
	return true
}

// IsServerError returns true when this entities content pattern create conflict response has a 5xx status code
func (o *EntitiesContentPatternCreateConflict) IsServerError() bool {
	return false
}

// IsCode returns true when this entities content pattern create conflict response a status code equal to that given
func (o *EntitiesContentPatternCreateConflict) IsCode(code int) bool {
	return code == 409
}

// Code gets the status code for the entities content pattern create conflict response
func (o *EntitiesContentPatternCreateConflict) Code() int {
	return 409
}

func (o *EntitiesContentPatternCreateConflict) Error() string {
	return fmt.Sprintf("[POST /data-protection/entities/content-patterns/v1][%d] entitiesContentPatternCreateConflict  %+v", 409, o.Payload)
}

func (o *EntitiesContentPatternCreateConflict) String() string {
	return fmt.Sprintf("[POST /data-protection/entities/content-patterns/v1][%d] entitiesContentPatternCreateConflict  %+v", 409, o.Payload)
}

func (o *EntitiesContentPatternCreateConflict) GetPayload() *models.MsaspecResponseFields {
	return o.Payload
}

func (o *EntitiesContentPatternCreateConflict) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
