...
func (o *EntitiesContentPatternDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 207:
		result := NewEntitiesContentPatternDeleteMultiStatus()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
...
// NewEntitiesContentPatternDeleteMultiStatus creates a EntitiesContentPatternDeleteMultiStatus with default headers values
func NewEntitiesContentPatternDeleteMultiStatus() *EntitiesContentPatternDeleteMultiStatus {
	return &EntitiesContentPatternDeleteMultiStatus{}
}

/*
EntitiesContentPatternDeleteMultiStatus describes a response with status code 207, with default header values.

Multi-Status
*/
type EntitiesContentPatternDeleteMultiStatus struct {
...
// IsSuccess returns true when this entities content pattern delete multi status response has a 2xx status code
func (o *EntitiesContentPatternDeleteMultiStatus) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this entities content pattern delete multi status response has a 3xx status code
func (o *EntitiesContentPatternDeleteMultiStatus) IsRedirect() bool {
	return false
}

// IsClientError returns true when this entities content pattern delete multi status response has a 4xx status code
func (o *EntitiesContentPatternDeleteMultiStatus) IsClientError() bool {
	return false
}

// IsServerError returns true when this entities content pattern delete multi status response has a 5xx status code
func (o *EntitiesContentPatternDeleteMultiStatus) IsServerError() bool {
	return false
}

// IsCode returns true when this entities content pattern delete multi status response a status code equal to that given
func (o *EntitiesContentPatternDeleteMultiStatus) IsCode(code int) bool {
	return code == 207
}

// Code gets the status code for the entities content pattern delete multi status response
func (o *EntitiesContentPatternDeleteMultiStatus) Code() int {
	return 207
}

func (o *EntitiesContentPatternDeleteMultiStatus) Error() string {
	return fmt.Sprintf("[DELETE /data-protection/entities/content-patterns/v1][%d] entitiesContentPatternDeleteMultiStatus  %+v", 207, o.Payload)
}

func (o *EntitiesContentPatternDeleteMultiStatus) String() string {
	return fmt.Sprintf("[DELETE /data-protection/entities/content-patterns/v1][%d] entitiesContentPatternDeleteMultiStatus  %+v", 207, o.Payload)
}

func (o *EntitiesContentPatternDeleteMultiStatus) GetPayload() *models.APIContentPatternMSAResponseV1 {
	return o.Payload
}

func (o *EntitiesContentPatternDeleteMultiStatus) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
