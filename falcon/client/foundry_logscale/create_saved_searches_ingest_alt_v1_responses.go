...
func (o *CreateSavedSearchesIngestAltV1OK) Error() string {
	...
	return fmt.Sprintf("[POST /loggingapi/entities/saved-searches-ingest/v1][%d] createSavedSearchesIngestAltV1OK %s", 200, payload)
}
...
func (o *CreateSavedSearchesIngestAltV1BadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /loggingapi/entities/saved-searches-ingest/v1][%d] createSavedSearchesIngestAltV1BadRequest %s", 400, payload)
}
...
func (o *CreateSavedSearchesIngestAltV1Forbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /loggingapi/entities/saved-searches-ingest/v1][%d] createSavedSearchesIngestAltV1Forbidden %s", 403, payload)
}
...
func (o *CreateSavedSearchesIngestAltV1NotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /loggingapi/entities/saved-searches-ingest/v1][%d] createSavedSearchesIngestAltV1NotFound %s", 404, payload)
}
...
func (o *CreateSavedSearchesIngestAltV1TooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /loggingapi/entities/saved-searches-ingest/v1][%d] createSavedSearchesIngestAltV1TooManyRequests %s", 429, payload)
}
...
func (o *CreateSavedSearchesIngestAltV1InternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /loggingapi/entities/saved-searches-ingest/v1][%d] createSavedSearchesIngestAltV1InternalServerError %s", 500, payload)
}
