...
func (o *QueryDevicesByFilterReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 429:
		...
		return nil, result
	case 500:
		result := NewQueryDevicesByFilterInternalServerError()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *QueryDevicesByFilterOK) Error() string {
	...
	return fmt.Sprintf("[GET /devices/queries/devices/v1][%d] queryDevicesByFilterOK %s", 200, payload)
}
...
func (o *QueryDevicesByFilterForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /devices/queries/devices/v1][%d] queryDevicesByFilterForbidden %s", 403, payload)
}
...
func (o *QueryDevicesByFilterTooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /devices/queries/devices/v1][%d] queryDevicesByFilterTooManyRequests %s", 429, payload)
}
...
// NewQueryDevicesByFilterInternalServerError creates a QueryDevicesByFilterInternalServerError with default headers values
func NewQueryDevicesByFilterInternalServerError() *QueryDevicesByFilterInternalServerError {
	return &QueryDevicesByFilterInternalServerError{}
}

/*
QueryDevicesByFilterInternalServerError describes a response with status code 500, with default header values.

Unexpected Error
*/
type QueryDevicesByFilterInternalServerError struct {
...
// IsSuccess returns true when this query devices by filter internal server error response has a 2xx status code
func (o *QueryDevicesByFilterInternalServerError) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this query devices by filter internal server error response has a 3xx status code
func (o *QueryDevicesByFilterInternalServerError) IsRedirect() bool {
	return false
}

// IsClientError returns true when this query devices by filter internal server error response has a 4xx status code
func (o *QueryDevicesByFilterInternalServerError) IsClientError() bool {
	return false
}

// IsServerError returns true when this query devices by filter internal server error response has a 5xx status code
func (o *QueryDevicesByFilterInternalServerError) IsServerError() bool {
	return true
}

// IsCode returns true when this query devices by filter internal server error response a status code equal to that given
func (o *QueryDevicesByFilterInternalServerError) IsCode(code int) bool {
	return code == 500
}

// Code gets the status code for the query devices by filter internal server error response
func (o *QueryDevicesByFilterInternalServerError) Code() int {
	return 500
}

func (o *QueryDevicesByFilterInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /devices/queries/devices/v1][%d] queryDevicesByFilterInternalServerError %s", 500, payload)
}

func (o *QueryDevicesByFilterInternalServerError) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /devices/queries/devices/v1][%d] queryDevicesByFilterInternalServerError %s", 500, payload)
}

func (o *QueryDevicesByFilterInternalServerError) GetPayload() *models.MsaReplyMetaOnly {
	return o.Payload
}

func (o *QueryDevicesByFilterInternalServerError) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
