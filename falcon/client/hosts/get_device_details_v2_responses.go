...
func (o *GetDeviceDetailsV2Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 429:
		...
		return nil, result
	case 500:
		result := NewGetDeviceDetailsV2InternalServerError()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetDeviceDetailsV2InternalServerError creates a GetDeviceDetailsV2InternalServerError with default headers values
func NewGetDeviceDetailsV2InternalServerError() *GetDeviceDetailsV2InternalServerError {
	return &GetDeviceDetailsV2InternalServerError{}
}

/*
GetDeviceDetailsV2InternalServerError describes a response with status code 500, with default header values.

Unexpected Error
*/
type GetDeviceDetailsV2InternalServerError struct {
...
// IsSuccess returns true when this get device details v2 internal server error response has a 2xx status code
func (o *GetDeviceDetailsV2InternalServerError) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get device details v2 internal server error response has a 3xx status code
func (o *GetDeviceDetailsV2InternalServerError) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get device details v2 internal server error response has a 4xx status code
func (o *GetDeviceDetailsV2InternalServerError) IsClientError() bool {
	return false
}

// IsServerError returns true when this get device details v2 internal server error response has a 5xx status code
func (o *GetDeviceDetailsV2InternalServerError) IsServerError() bool {
	return true
}

// IsCode returns true when this get device details v2 internal server error response a status code equal to that given
func (o *GetDeviceDetailsV2InternalServerError) IsCode(code int) bool {
	return code == 500
}

// Code gets the status code for the get device details v2 internal server error response
func (o *GetDeviceDetailsV2InternalServerError) Code() int {
	return 500
}
...
func (o *GetDeviceDetailsV2InternalServerError) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
