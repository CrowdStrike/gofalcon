...
func (o *PostDeviceDetailsV2Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 429:
		...
		return nil, result
	case 500:
		result := NewPostDeviceDetailsV2InternalServerError()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *PostDeviceDetailsV2OK) Error() string {
	...
	return fmt.Sprintf("[POST /devices/entities/devices/v2][%d] postDeviceDetailsV2OK %s", 200, payload)
}
...
func (o *PostDeviceDetailsV2Forbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /devices/entities/devices/v2][%d] postDeviceDetailsV2Forbidden %s", 403, payload)
}
...
func (o *PostDeviceDetailsV2TooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /devices/entities/devices/v2][%d] postDeviceDetailsV2TooManyRequests %s", 429, payload)
}
...
// NewPostDeviceDetailsV2InternalServerError creates a PostDeviceDetailsV2InternalServerError with default headers values
func NewPostDeviceDetailsV2InternalServerError() *PostDeviceDetailsV2InternalServerError {
	return &PostDeviceDetailsV2InternalServerError{}
}

/*
PostDeviceDetailsV2InternalServerError describes a response with status code 500, with default header values.

Unexpected Error
*/
type PostDeviceDetailsV2InternalServerError struct {
...
// IsSuccess returns true when this post device details v2 internal server error response has a 2xx status code
func (o *PostDeviceDetailsV2InternalServerError) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this post device details v2 internal server error response has a 3xx status code
func (o *PostDeviceDetailsV2InternalServerError) IsRedirect() bool {
	return false
}

// IsClientError returns true when this post device details v2 internal server error response has a 4xx status code
func (o *PostDeviceDetailsV2InternalServerError) IsClientError() bool {
	return false
}

// IsServerError returns true when this post device details v2 internal server error response has a 5xx status code
func (o *PostDeviceDetailsV2InternalServerError) IsServerError() bool {
	return true
}

// IsCode returns true when this post device details v2 internal server error response a status code equal to that given
func (o *PostDeviceDetailsV2InternalServerError) IsCode(code int) bool {
	return code == 500
}

// Code gets the status code for the post device details v2 internal server error response
func (o *PostDeviceDetailsV2InternalServerError) Code() int {
	return 500
}

func (o *PostDeviceDetailsV2InternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /devices/entities/devices/v2][%d] postDeviceDetailsV2InternalServerError %s", 500, payload)
}

func (o *PostDeviceDetailsV2InternalServerError) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /devices/entities/devices/v2][%d] postDeviceDetailsV2InternalServerError %s", 500, payload)
}

func (o *PostDeviceDetailsV2InternalServerError) GetPayload() *models.MsaReplyMetaOnly {
	return o.Payload
}

func (o *PostDeviceDetailsV2InternalServerError) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
