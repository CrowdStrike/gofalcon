...
func (o *QueryGetNetworkAddressHistoryV1Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 429:
		...
		return nil, result
	default:
		result := NewQueryGetNetworkAddressHistoryV1Default(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewQueryGetNetworkAddressHistoryV1Default(code int) *QueryGetNetworkAddressHistoryV1Default {
	return &QueryGetNetworkAddressHistoryV1Default{
		_statusCode: code,
	}
}
...
// IsRedirect returns true when this query get network address history v1 default response has a 3xx status code
func (o *QueryGetNetworkAddressHistoryV1Default) IsRedirect() bool {
	return o._statusCode/100 == 3
}

// IsClientError returns true when this query get network address history v1 default response has a 4xx status code
func (o *QueryGetNetworkAddressHistoryV1Default) IsClientError() bool {
	return o._statusCode/100 == 4
}

// IsServerError returns true when this query get network address history v1 default response has a 5xx status code
func (o *QueryGetNetworkAddressHistoryV1Default) IsServerError() bool {
...
func (o *QueryGetNetworkAddressHistoryV1Default) Error() string {
	return fmt.Sprintf("[POST /devices/combined/devices/network-address-history/v1][%d] QueryGetNetworkAddressHistoryV1 default  %+v", o._statusCode, o.Payload)
}

func (o *QueryGetNetworkAddressHistoryV1Default) String() string {
	return fmt.Sprintf("[POST /devices/combined/devices/network-address-history/v1][%d] QueryGetNetworkAddressHistoryV1 default  %+v", o._statusCode, o.Payload)
}
...
func (o *QueryGetNetworkAddressHistoryV1Default) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
