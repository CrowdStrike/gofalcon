...
func (o *QueryGetNetworkAddressHistoryV1Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 429:
		...
		return nil, result
	case 500:
		result := NewQueryGetNetworkAddressHistoryV1InternalServerError()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *QueryGetNetworkAddressHistoryV1OK) Error() string {
	...
	return fmt.Sprintf("[POST /devices/combined/devices/network-address-history/v1][%d] queryGetNetworkAddressHistoryV1OK %s", 200, payload)
}
...
func (o *QueryGetNetworkAddressHistoryV1Forbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /devices/combined/devices/network-address-history/v1][%d] queryGetNetworkAddressHistoryV1Forbidden %s", 403, payload)
}
...
func (o *QueryGetNetworkAddressHistoryV1TooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /devices/combined/devices/network-address-history/v1][%d] queryGetNetworkAddressHistoryV1TooManyRequests %s", 429, payload)
}
...
// NewQueryGetNetworkAddressHistoryV1InternalServerError creates a QueryGetNetworkAddressHistoryV1InternalServerError with default headers values
func NewQueryGetNetworkAddressHistoryV1InternalServerError() *QueryGetNetworkAddressHistoryV1InternalServerError {
	return &QueryGetNetworkAddressHistoryV1InternalServerError{}
}

/*
QueryGetNetworkAddressHistoryV1InternalServerError describes a response with status code 500, with default header values.

Unexpected Error
*/
type QueryGetNetworkAddressHistoryV1InternalServerError struct {
...
// IsSuccess returns true when this query get network address history v1 internal server error response has a 2xx status code
func (o *QueryGetNetworkAddressHistoryV1InternalServerError) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this query get network address history v1 internal server error response has a 3xx status code
func (o *QueryGetNetworkAddressHistoryV1InternalServerError) IsRedirect() bool {
	return false
}

// IsClientError returns true when this query get network address history v1 internal server error response has a 4xx status code
func (o *QueryGetNetworkAddressHistoryV1InternalServerError) IsClientError() bool {
	return false
}

// IsServerError returns true when this query get network address history v1 internal server error response has a 5xx status code
func (o *QueryGetNetworkAddressHistoryV1InternalServerError) IsServerError() bool {
	return true
}

// IsCode returns true when this query get network address history v1 internal server error response a status code equal to that given
func (o *QueryGetNetworkAddressHistoryV1InternalServerError) IsCode(code int) bool {
	return code == 500
}

// Code gets the status code for the query get network address history v1 internal server error response
func (o *QueryGetNetworkAddressHistoryV1InternalServerError) Code() int {
	return 500
}

func (o *QueryGetNetworkAddressHistoryV1InternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /devices/combined/devices/network-address-history/v1][%d] queryGetNetworkAddressHistoryV1InternalServerError %s", 500, payload)
}

func (o *QueryGetNetworkAddressHistoryV1InternalServerError) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /devices/combined/devices/network-address-history/v1][%d] queryGetNetworkAddressHistoryV1InternalServerError %s", 500, payload)
}

func (o *QueryGetNetworkAddressHistoryV1InternalServerError) GetPayload() *models.MsaReplyMetaOnly {
	return o.Payload
}

func (o *QueryGetNetworkAddressHistoryV1InternalServerError) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
