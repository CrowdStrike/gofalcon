...
func (o *CustomerSettingsUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		result := NewCustomerSettingsUpdateDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
// NewCustomerSettingsUpdateDefault creates a CustomerSettingsUpdateDefault with default headers values
func NewCustomerSettingsUpdateDefault(code int) *CustomerSettingsUpdateDefault {
	return &CustomerSettingsUpdateDefault{
		_statusCode: code,
	}
}

/*
CustomerSettingsUpdateDefault describes a response with status code -1, with default header values.

OK
*/
type CustomerSettingsUpdateDefault struct {
	_statusCode int

	Payload *models.MsaQueryResponse
}

// Code gets the status code for the customer settings update default response
func (o *CustomerSettingsUpdateDefault) Code() int {
	return o._statusCode
}

// IsSuccess returns true when this customer settings update default response has a 2xx status code
func (o *CustomerSettingsUpdateDefault) IsSuccess() bool {
	return o._statusCode/100 == 2
}

// IsRedirect returns true when this customer settings update default response has a 3xx status code
func (o *CustomerSettingsUpdateDefault) IsRedirect() bool {
	return o._statusCode/100 == 3
}

// IsClientError returns true when this customer settings update default response has a 4xx status code
func (o *CustomerSettingsUpdateDefault) IsClientError() bool {
	return o._statusCode/100 == 4
}

// IsServerError returns true when this customer settings update default response has a 5xx status code
func (o *CustomerSettingsUpdateDefault) IsServerError() bool {
	return o._statusCode/100 == 5
}

// IsCode returns true when this customer settings update default response a status code equal to that given
func (o *CustomerSettingsUpdateDefault) IsCode(code int) bool {
	return o._statusCode == code
}

func (o *CustomerSettingsUpdateDefault) Error() string {
	return fmt.Sprintf("[PATCH /installation-tokens/entities/customer-settings/v1][%d] customer-settings-update default  %+v", o._statusCode, o.Payload)
}

func (o *CustomerSettingsUpdateDefault) String() string {
	return fmt.Sprintf("[PATCH /installation-tokens/entities/customer-settings/v1][%d] customer-settings-update default  %+v", o._statusCode, o.Payload)
}

func (o *CustomerSettingsUpdateDefault) GetPayload() *models.MsaQueryResponse {
	return o.Payload
}

func (o *CustomerSettingsUpdateDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
