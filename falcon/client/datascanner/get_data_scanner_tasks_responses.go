...
func (o *GetDataScannerTasksReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 429:
		...
		return nil, result
	case 500:
		result := NewGetDataScannerTasksInternalServerError()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetDataScannerTasksInternalServerError creates a GetDataScannerTasksInternalServerError with default headers values
func NewGetDataScannerTasksInternalServerError() *GetDataScannerTasksInternalServerError {
	return &GetDataScannerTasksInternalServerError{}
}

/*
GetDataScannerTasksInternalServerError describes a response with status code 500, with default header values.

Unexpected Error
*/
type GetDataScannerTasksInternalServerError struct {
...
// IsSuccess returns true when this get data scanner tasks internal server error response has a 2xx status code
func (o *GetDataScannerTasksInternalServerError) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get data scanner tasks internal server error response has a 3xx status code
func (o *GetDataScannerTasksInternalServerError) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get data scanner tasks internal server error response has a 4xx status code
func (o *GetDataScannerTasksInternalServerError) IsClientError() bool {
	return false
}

// IsServerError returns true when this get data scanner tasks internal server error response has a 5xx status code
func (o *GetDataScannerTasksInternalServerError) IsServerError() bool {
	return true
}

// IsCode returns true when this get data scanner tasks internal server error response a status code equal to that given
func (o *GetDataScannerTasksInternalServerError) IsCode(code int) bool {
	return code == 500
}

// Code gets the status code for the get data scanner tasks internal server error response
func (o *GetDataScannerTasksInternalServerError) Code() int {
	return 500
}

func (o *GetDataScannerTasksInternalServerError) Error() string {
	return fmt.Sprintf("[GET /data-security-dspm/entities/scanner-tasks/v1][%d] getDataScannerTasksInternalServerError  %+v", 500, o.Payload)
}

func (o *GetDataScannerTasksInternalServerError) String() string {
	return fmt.Sprintf("[GET /data-security-dspm/entities/scanner-tasks/v1][%d] getDataScannerTasksInternalServerError  %+v", 500, o.Payload)
}

func (o *GetDataScannerTasksInternalServerError) GetPayload() *models.MsaReplyMetaOnly {
	return o.Payload
}

func (o *GetDataScannerTasksInternalServerError) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
