...
func (o *ArchiveListV1OK) Error() string {
	...
	return fmt.Sprintf("[GET /archives/entities/archive-files/v1][%d] archiveListV1OK %s", 200, payload)
}
...
func (o *ArchiveListV1BadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /archives/entities/archive-files/v1][%d] archiveListV1BadRequest %s", 400, payload)
}
...
func (o *ArchiveListV1Forbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /archives/entities/archive-files/v1][%d] archiveListV1Forbidden %s", 403, payload)
}
...
func (o *ArchiveListV1TooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /archives/entities/archive-files/v1][%d] archiveListV1TooManyRequests %s", 429, payload)
}
...
func (o *ArchiveListV1InternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /archives/entities/archive-files/v1][%d] archiveListV1InternalServerError %s", 500, payload)
}
