...
func (o *ExtractionListV1OK) Error() string {
	...
	return fmt.Sprintf("[GET /archives/entities/extraction-files/v1][%d] extractionListV1OK %s", 200, payload)
}
...
func (o *ExtractionListV1BadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /archives/entities/extraction-files/v1][%d] extractionListV1BadRequest %s", 400, payload)
}
...
func (o *ExtractionListV1Forbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /archives/entities/extraction-files/v1][%d] extractionListV1Forbidden %s", 403, payload)
}
...
func (o *ExtractionListV1TooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /archives/entities/extraction-files/v1][%d] extractionListV1TooManyRequests %s", 429, payload)
}
...
func (o *ExtractionListV1InternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /archives/entities/extraction-files/v1][%d] extractionListV1InternalServerError %s", 500, payload)
}
