...
// WithXCSUSERUUID adds the xCSUSERUUID to the aggregate detections params
func (o *AggregateDetectionsParams) WithXCSUSERUUID(xCSUSERUUID *string) *AggregateDetectionsParams {
	o.SetXCSUSERUUID(xCSUSERUUID)
	return o
}

// SetXCSUSERUUID adds the xCSUSERUuid to the aggregate detections params
func (o *AggregateDetectionsParams) SetXCSUSERUUID(xCSUSERUUID *string) {
