...
func (o *CombinedDetectionsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /netscan/combined/detections/v1] combined-detections", response, response.Code())
	}
}
...
func (o *CombinedDetectionsOK) Error() string {
	return fmt.Sprintf("[GET /netscan/combined/detections/v1][%d] combinedDetectionsOK  %+v", 200, o.Payload)
}
...
func (o *CombinedDetectionsOK) GetPayload() *models.NvaapiDetectionEntitiesResponse {
	return o.Payload
}
...
func (o *CombinedDetectionsBadRequest) Error() string {
	return fmt.Sprintf("[GET /netscan/combined/detections/v1][%d] combinedDetectionsBadRequest  %+v", 400, o.Payload)
}
...
func (o *CombinedDetectionsForbidden) Error() string {
	return fmt.Sprintf("[GET /netscan/combined/detections/v1][%d] combinedDetectionsForbidden  %+v", 403, o.Payload)
}
...
func (o *CombinedDetectionsTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /netscan/combined/detections/v1][%d] combinedDetectionsTooManyRequests  %+v", 429, o.Payload)
}
...
func (o *CombinedDetectionsInternalServerError) Error() string {
	return fmt.Sprintf("[GET /netscan/combined/detections/v1][%d] combinedDetectionsInternalServerError  %+v", 500, o.Payload)
}
