...
// WithXCSUSERUUID adds the xCSUSERUUID to the combined detections params
func (o *CombinedDetectionsParams) WithXCSUSERUUID(xCSUSERUUID *string) *CombinedDetectionsParams {
	o.SetXCSUSERUUID(xCSUSERUUID)
	return o
}

// SetXCSUSERUUID adds the xCSUSERUuid to the combined detections params
func (o *CombinedDetectionsParams) SetXCSUSERUUID(xCSUSERUUID *string) {
