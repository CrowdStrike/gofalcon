...
func (o *GetPreventionPoliciesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewGetPreventionPoliciesBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetPreventionPoliciesBadRequest creates a GetPreventionPoliciesBadRequest with default headers values
func NewGetPreventionPoliciesBadRequest() *GetPreventionPoliciesBadRequest {
	return &GetPreventionPoliciesBadRequest{}
}
...
// IsSuccess returns true when this get prevention policies bad request response has a 2xx status code
func (o *GetPreventionPoliciesBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get prevention policies bad request response has a 3xx status code
func (o *GetPreventionPoliciesBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get prevention policies bad request response has a 4xx status code
func (o *GetPreventionPoliciesBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this get prevention policies bad request response has a 5xx status code
func (o *GetPreventionPoliciesBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this get prevention policies bad request response a status code equal to that given
func (o *GetPreventionPoliciesBadRequest) IsCode(code int) bool {
	return code == 400
}

// Code gets the status code for the get prevention policies bad request response
func (o *GetPreventionPoliciesBadRequest) Code() int {
	return 400
}

func (o *GetPreventionPoliciesBadRequest) Error() string {
	return fmt.Sprintf("[GET /policy/entities/prevention/v1][%d] getPreventionPoliciesBadRequest  %+v", 400, o.Payload)
}

func (o *GetPreventionPoliciesBadRequest) String() string {
	return fmt.Sprintf("[GET /policy/entities/prevention/v1][%d] getPreventionPoliciesBadRequest  %+v", 400, o.Payload)
}

func (o *GetPreventionPoliciesBadRequest) GetPayload() *models.PreventionRespV1 {
	return o.Payload
}

func (o *GetPreventionPoliciesBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
