...
// NewGetDefaultDeviceControlPoliciesParams creates a new GetDefaultDeviceControlPoliciesParams object,
...
func NewGetDefaultDeviceControlPoliciesParams() *GetDefaultDeviceControlPoliciesParams {
	return &GetDefaultDeviceControlPoliciesParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewGetDefaultDeviceControlPoliciesParamsWithTimeout creates a new GetDefaultDeviceControlPoliciesParams object
...
// NewGetDefaultDeviceControlPoliciesParamsWithContext creates a new GetDefaultDeviceControlPoliciesParams object
...
// NewGetDefaultDeviceControlPoliciesParamsWithHTTPClient creates a new GetDefaultDeviceControlPoliciesParams object
...
func (o *GetDefaultDeviceControlPoliciesParams) WithDefaults() *GetDefaultDeviceControlPoliciesParams {
	o.SetDefaults()
	return o
}
...
func (o *GetDefaultDeviceControlPoliciesParams) WithTimeout(timeout time.Duration) *GetDefaultDeviceControlPoliciesParams {
...
func (o *GetDefaultDeviceControlPoliciesParams) WithContext(ctx context.Context) *GetDefaultDeviceControlPoliciesParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get default device control policies params
func (o *GetDefaultDeviceControlPoliciesParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get default device control policies params
func (o *GetDefaultDeviceControlPoliciesParams) WithHTTPClient(client *http.Client) *GetDefaultDeviceControlPoliciesParams {
...
func (o *GetDefaultDeviceControlPoliciesParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
