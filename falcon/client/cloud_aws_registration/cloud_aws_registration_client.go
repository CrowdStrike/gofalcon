...
type ClientService interface {
	...
	CloudRegistrationAwsTriggerHealthCheck(params *CloudRegistrationAwsTriggerHealthCheckParams, opts ...ClientOption) (*CloudRegistrationAwsTriggerHealthCheckOK, error)
...
/*
CloudRegistrationAwsTriggerHealthCheck triggers health check scan for a w s accounts
*/
func (a *Client) CloudRegistrationAwsTriggerHealthCheck(params *CloudRegistrationAwsTriggerHealthCheckParams, opts ...ClientOption) (*CloudRegistrationAwsTriggerHealthCheckOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewCloudRegistrationAwsTriggerHealthCheckParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "cloud-registration-aws-trigger-health-check",
		Method:             "POST",
	...
	success, ok := result.(*CloudRegistrationAwsTriggerHealthCheckOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for cloud-registration-aws-trigger-health-check: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
/*
CloudRegistrationAwsValidateAccounts validates the a w s account registration status and discover organization child accounts if organization is specified
*/
