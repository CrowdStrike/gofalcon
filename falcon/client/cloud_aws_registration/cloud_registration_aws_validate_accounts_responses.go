...
func (o *CloudRegistrationAwsValidateAccountsBadRequest) GetPayload() *models.MsaspecResponseFields {
	return o.Payload
}
...
func (o *CloudRegistrationAwsValidateAccountsInternalServerError) GetPayload() *models.MsaspecResponseFields {
	return o.Payload
}
