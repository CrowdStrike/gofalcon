...
func (o *WorkflowMockExecuteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 400:
		...
		return nil, result
	case 401:
		result := NewWorkflowMockExecuteUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewWorkflowMockExecuteUnauthorized creates a WorkflowMockExecuteUnauthorized with default headers values
func NewWorkflowMockExecuteUnauthorized() *WorkflowMockExecuteUnauthorized {
	return &WorkflowMockExecuteUnauthorized{}
}

/*
WorkflowMockExecuteUnauthorized describes a response with status code 401, with default header values.

Unauthorized
*/
type WorkflowMockExecuteUnauthorized struct {
...
// IsSuccess returns true when this workflow mock execute unauthorized response has a 2xx status code
func (o *WorkflowMockExecuteUnauthorized) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this workflow mock execute unauthorized response has a 3xx status code
func (o *WorkflowMockExecuteUnauthorized) IsRedirect() bool {
	return false
}

// IsClientError returns true when this workflow mock execute unauthorized response has a 4xx status code
func (o *WorkflowMockExecuteUnauthorized) IsClientError() bool {
	return true
}

// IsServerError returns true when this workflow mock execute unauthorized response has a 5xx status code
func (o *WorkflowMockExecuteUnauthorized) IsServerError() bool {
	return false
}

// IsCode returns true when this workflow mock execute unauthorized response a status code equal to that given
func (o *WorkflowMockExecuteUnauthorized) IsCode(code int) bool {
	return code == 401
}

// Code gets the status code for the workflow mock execute unauthorized response
func (o *WorkflowMockExecuteUnauthorized) Code() int {
	return 401
}

func (o *WorkflowMockExecuteUnauthorized) Error() string {
	return fmt.Sprintf("[POST /workflows/entities/mock-executions/v1][%d] workflowMockExecuteUnauthorized  %+v", 401, o.Payload)
}

func (o *WorkflowMockExecuteUnauthorized) String() string {
	return fmt.Sprintf("[POST /workflows/entities/mock-executions/v1][%d] workflowMockExecuteUnauthorized  %+v", 401, o.Payload)
}

func (o *WorkflowMockExecuteUnauthorized) GetPayload() *models.APIMFAResourceIDsResponse {
	return o.Payload
}

func (o *WorkflowMockExecuteUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
