...
func (o *WorkflowUpdateHumanInputV1OK) Error() string {
	...
	return fmt.Sprintf("[PATCH /workflows/entities/human-inputs/v1][%d] workflowUpdateHumanInputV1OK %s", 200, payload)
}
...
func (o *WorkflowUpdateHumanInputV1BadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /workflows/entities/human-inputs/v1][%d] workflowUpdateHumanInputV1BadRequest %s", 400, payload)
}
...
func (o *WorkflowUpdateHumanInputV1Forbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /workflows/entities/human-inputs/v1][%d] workflowUpdateHumanInputV1Forbidden %s", 403, payload)
}
...
func (o *WorkflowUpdateHumanInputV1NotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /workflows/entities/human-inputs/v1][%d] workflowUpdateHumanInputV1NotFound %s", 404, payload)
}
...
func (o *WorkflowUpdateHumanInputV1TooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /workflows/entities/human-inputs/v1][%d] workflowUpdateHumanInputV1TooManyRequests %s", 429, payload)
}
...
func (o *WorkflowUpdateHumanInputV1InternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /workflows/entities/human-inputs/v1][%d] workflowUpdateHumanInputV1InternalServerError %s", 500, payload)
}
