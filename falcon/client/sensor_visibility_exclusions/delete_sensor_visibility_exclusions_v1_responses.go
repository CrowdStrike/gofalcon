...
func (o *DeleteSensorVisibilityExclusionsV1OK) Error() string {
	...
	return fmt.Sprintf("[DELETE /policy/entities/sv-exclusions/v1][%d] deleteSensorVisibilityExclusionsV1OK %s", 200, payload)
}
...
func (o *DeleteSensorVisibilityExclusionsV1BadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /policy/entities/sv-exclusions/v1][%d] deleteSensorVisibilityExclusionsV1BadRequest %s", 400, payload)
}
...
func (o *DeleteSensorVisibilityExclusionsV1Forbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /policy/entities/sv-exclusions/v1][%d] deleteSensorVisibilityExclusionsV1Forbidden %s", 403, payload)
}
...
func (o *DeleteSensorVisibilityExclusionsV1TooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /policy/entities/sv-exclusions/v1][%d] deleteSensorVisibilityExclusionsV1TooManyRequests %s", 429, payload)
}
...
func (o *DeleteSensorVisibilityExclusionsV1InternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /policy/entities/sv-exclusions/v1][%d] deleteSensorVisibilityExclusionsV1InternalServerError %s", 500, payload)
}
