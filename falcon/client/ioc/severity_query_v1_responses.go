...
func (o *SeverityQueryV1OK) Error() string {
	...
	return fmt.Sprintf("[GET /iocs/queries/severities/v1][%d] severityQueryV1OK %s", 200, payload)
}
...
func (o *SeverityQueryV1Forbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /iocs/queries/severities/v1][%d] severityQueryV1Forbidden %s", 403, payload)
}
...
func (o *SeverityQueryV1TooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /iocs/queries/severities/v1][%d] severityQueryV1TooManyRequests %s", 429, payload)
}
...
func (o *SeverityQueryV1InternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /iocs/queries/severities/v1][%d] severityQueryV1InternalServerError %s", 500, payload)
}
