...
func (o *SeverityQueryV1Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 429:
		...
		return nil, result
	default:
		result := NewSeverityQueryV1Default(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
OK
*/
type SeverityQueryV1Default struct {
	_statusCode int
...
func (o *SeverityQueryV1Default) Error() string {
	return fmt.Sprintf("[GET /iocs/queries/severities/v1][%d] severity.query.v1 default  %+v", o._statusCode, o.Payload)
}
...
func (o *SeverityQueryV1Default) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
