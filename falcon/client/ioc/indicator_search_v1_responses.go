...
func (o *IndicatorSearchV1OK) Error() string {
	...
	return fmt.Sprintf("[GET /iocs/queries/indicators/v1][%d] indicatorSearchV1OK %s", 200, payload)
}
...
func (o *IndicatorSearchV1BadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /iocs/queries/indicators/v1][%d] indicatorSearchV1BadRequest %s", 400, payload)
}
...
func (o *IndicatorSearchV1Forbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /iocs/queries/indicators/v1][%d] indicatorSearchV1Forbidden %s", 403, payload)
}
...
func (o *IndicatorSearchV1TooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /iocs/queries/indicators/v1][%d] indicatorSearchV1TooManyRequests %s", 429, payload)
}
...
func (o *IndicatorSearchV1InternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /iocs/queries/indicators/v1][%d] indicatorSearchV1InternalServerError %s", 500, payload)
}
