...
func (o *IndicatorGetProcessesRanOnV1OK) Error() string {
	...
	return fmt.Sprintf("[GET /iocs/queries/indicators/processes/v1][%d] indicatorGetProcessesRanOnV1OK %s", 200, payload)
}
...
func (o *IndicatorGetProcessesRanOnV1BadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /iocs/queries/indicators/processes/v1][%d] indicatorGetProcessesRanOnV1BadRequest %s", 400, payload)
}
...
func (o *IndicatorGetProcessesRanOnV1Forbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /iocs/queries/indicators/processes/v1][%d] indicatorGetProcessesRanOnV1Forbidden %s", 403, payload)
}
...
func (o *IndicatorGetProcessesRanOnV1TooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /iocs/queries/indicators/processes/v1][%d] indicatorGetProcessesRanOnV1TooManyRequests %s", 429, payload)
}
...
func (o *IndicatorGetProcessesRanOnV1InternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /iocs/queries/indicators/processes/v1][%d] indicatorGetProcessesRanOnV1InternalServerError %s", 500, payload)
}
