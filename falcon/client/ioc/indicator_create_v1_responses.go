...
func (o *IndicatorCreateV1Created) Error() string {
	...
	return fmt.Sprintf("[POST /iocs/entities/indicators/v1][%d] indicatorCreateV1Created %s", 201, payload)
}
...
func (o *IndicatorCreateV1BadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /iocs/entities/indicators/v1][%d] indicatorCreateV1BadRequest %s", 400, payload)
}
...
func (o *IndicatorCreateV1Forbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /iocs/entities/indicators/v1][%d] indicatorCreateV1Forbidden %s", 403, payload)
}
...
func (o *IndicatorCreateV1TooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /iocs/entities/indicators/v1][%d] indicatorCreateV1TooManyRequests %s", 429, payload)
}
...
func (o *IndicatorCreateV1InternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /iocs/entities/indicators/v1][%d] indicatorCreateV1InternalServerError %s", 500, payload)
}
