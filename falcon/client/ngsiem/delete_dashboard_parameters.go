...
// WithSearchDomain adds the searchDomain to the delete dashboard params
func (o *DeleteDashboardParams) WithSearchDomain(searchDomain *string) *DeleteDashboardParams {
	o.SetSearchDomain(searchDomain)
	return o
}

// SetSearchDomain adds the searchDomain to the delete dashboard params
func (o *DeleteDashboardParams) SetSearchDomain(searchDomain *string) {
