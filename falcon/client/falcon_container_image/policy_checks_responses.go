...
func (o *PolicyChecksOK) Error() string {
	return fmt.Sprintf("[GET /image-assessment/entities/policy-checks/v2][%d] policyChecksOK  %+v", 200, o.Payload)
}
...
func (o *PolicyChecksBadRequest) Error() string {
	return fmt.Sprintf("[GET /image-assessment/entities/policy-checks/v2][%d] policyChecksBadRequest  %+v", 400, o.Payload)
}
...
func (o *PolicyChecksForbidden) Error() string {
	return fmt.Sprintf("[GET /image-assessment/entities/policy-checks/v2][%d] policyChecksForbidden  %+v", 403, o.Payload)
}
...
func (o *PolicyChecksNotFound) Error() string {
	return fmt.Sprintf("[GET /image-assessment/entities/policy-checks/v2][%d] policyChecksNotFound  %+v", 404, o.Payload)
}
...
func (o *PolicyChecksTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /image-assessment/entities/policy-checks/v2][%d] policyChecksTooManyRequests  %+v", 429, o.Payload)
}
...
func (o *PolicyChecksInternalServerError) Error() string {
	return fmt.Sprintf("[GET /image-assessment/entities/policy-checks/v2][%d] policyChecksInternalServerError  %+v", 500, o.Payload)
}
