...
func (o *GetReportByReferenceOK) Error() string {
	...
	return fmt.Sprintf("[GET /image-assessment/entities/reports/v2][%d] getReportByReferenceOK %s", 200, payload)
}
...
func (o *GetReportByReferenceBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /image-assessment/entities/reports/v2][%d] getReportByReferenceBadRequest %s", 400, payload)
}
...
func (o *GetReportByReferenceForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /image-assessment/entities/reports/v2][%d] getReportByReferenceForbidden %s", 403, payload)
}
...
func (o *GetReportByReferenceNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /image-assessment/entities/reports/v2][%d] getReportByReferenceNotFound %s", 404, payload)
}
...
func (o *GetReportByReferenceTooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /image-assessment/entities/reports/v2][%d] getReportByReferenceTooManyRequests %s", 429, payload)
}
...
func (o *GetReportByReferenceInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /image-assessment/entities/reports/v2][%d] getReportByReferenceInternalServerError %s", 500, payload)
}
