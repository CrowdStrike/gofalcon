...
func (o *FdrschemaEntitiesFieldGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 429:
		...
		return nil, result
	case 500:
		result := NewFdrschemaEntitiesFieldGetInternalServerError()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewFdrschemaEntitiesFieldGetInternalServerError creates a FdrschemaEntitiesFieldGetInternalServerError with default headers values
func NewFdrschemaEntitiesFieldGetInternalServerError() *FdrschemaEntitiesFieldGetInternalServerError {
	return &FdrschemaEntitiesFieldGetInternalServerError{}
}

/*
FdrschemaEntitiesFieldGetInternalServerError describes a response with status code 500, with default header values.

Unexpected Error
*/
type FdrschemaEntitiesFieldGetInternalServerError struct {
...
// IsSuccess returns true when this fdrschema entities field get internal server error response has a 2xx status code
func (o *FdrschemaEntitiesFieldGetInternalServerError) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this fdrschema entities field get internal server error response has a 3xx status code
func (o *FdrschemaEntitiesFieldGetInternalServerError) IsRedirect() bool {
	return false
}

// IsClientError returns true when this fdrschema entities field get internal server error response has a 4xx status code
func (o *FdrschemaEntitiesFieldGetInternalServerError) IsClientError() bool {
	return false
}

// IsServerError returns true when this fdrschema entities field get internal server error response has a 5xx status code
func (o *FdrschemaEntitiesFieldGetInternalServerError) IsServerError() bool {
	return true
}

// IsCode returns true when this fdrschema entities field get internal server error response a status code equal to that given
func (o *FdrschemaEntitiesFieldGetInternalServerError) IsCode(code int) bool {
	return code == 500
}

// Code gets the status code for the fdrschema entities field get internal server error response
func (o *FdrschemaEntitiesFieldGetInternalServerError) Code() int {
	return 500
}
...
func (o *FdrschemaEntitiesFieldGetInternalServerError) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
