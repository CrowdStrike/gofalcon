...
func (o *GetFirewallFieldsParams) WithTimeout(timeout time.Duration) *GetFirewallFieldsParams {
...
func (o *GetFirewallFieldsParams) WithContext(ctx context.Context) *GetFirewallFieldsParams {
	o.SetContext(ctx)
	return o
}
...
func (o *GetFirewallFieldsParams) WithIds(ids []string) *GetFirewallFieldsParams {
	o.SetIds(ids)
	return o
}
...
func (o *GetFirewallFieldsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
