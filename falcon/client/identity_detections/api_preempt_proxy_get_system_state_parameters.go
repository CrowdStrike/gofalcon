...
// NewAPIPreemptProxyGetSystemStateParams creates a new APIPreemptProxyGetSystemStateParams object,
...
func NewAPIPreemptProxyGetSystemStateParams() *APIPreemptProxyGetSystemStateParams {
	return &APIPreemptProxyGetSystemStateParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewAPIPreemptProxyGetSystemStateParamsWithTimeout creates a new APIPreemptProxyGetSystemStateParams object
...
// NewAPIPreemptProxyGetSystemStateParamsWithContext creates a new APIPreemptProxyGetSystemStateParams object
...
// NewAPIPreemptProxyGetSystemStateParamsWithHTTPClient creates a new APIPreemptProxyGetSystemStateParams object
...
func (o *APIPreemptProxyGetSystemStateParams) WithDefaults() *APIPreemptProxyGetSystemStateParams {
	o.SetDefaults()
	return o
}
...
func (o *APIPreemptProxyGetSystemStateParams) WithTimeout(timeout time.Duration) *APIPreemptProxyGetSystemStateParams {
...
func (o *APIPreemptProxyGetSystemStateParams) WithContext(ctx context.Context) *APIPreemptProxyGetSystemStateParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the api preempt proxy get system state params
func (o *APIPreemptProxyGetSystemStateParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the api preempt proxy get system state params
func (o *APIPreemptProxyGetSystemStateParams) WithHTTPClient(client *http.Client) *APIPreemptProxyGetSystemStateParams {
...
func (o *APIPreemptProxyGetSystemStateParams) WithAuthorization(authorization string) *APIPreemptProxyGetSystemStateParams {
...
func (o *APIPreemptProxyGetSystemStateParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
