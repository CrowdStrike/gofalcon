...
func (o *PostMalQueryHuntV1Unauthorized) GetPayload() *models.MsaspecResponseFields {
	return o.Payload
}
...
func (o *PostMalQueryHuntV1Forbidden) GetPayload() *models.MsaspecResponseFields {
	return o.Payload
}
