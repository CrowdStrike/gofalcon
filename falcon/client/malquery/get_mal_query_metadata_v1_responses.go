...
func (o *GetMalQueryMetadataV1Unauthorized) GetPayload() *models.MsaspecResponseFields {
	return o.Payload
}
...
func (o *GetMalQueryMetadataV1Forbidden) GetPayload() *models.MsaspecResponseFields {
	return o.Payload
}
