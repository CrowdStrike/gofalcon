...
func (o *HandleReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 429:
		...
		return nil, result
	case 500:
		result := NewHandleInternalServerError()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewHandleInternalServerError creates a HandleInternalServerError with default headers values
func NewHandleInternalServerError() *HandleInternalServerError {
	return &HandleInternalServerError{}
}

/*
HandleInternalServerError describes a response with status code 500, with default header values.

Unexpected Error
*/
type HandleInternalServerError struct {
...
// IsSuccess returns true when this handle internal server error response has a 2xx status code
func (o *HandleInternalServerError) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this handle internal server error response has a 3xx status code
func (o *HandleInternalServerError) IsRedirect() bool {
	return false
}

// IsClientError returns true when this handle internal server error response has a 4xx status code
func (o *HandleInternalServerError) IsClientError() bool {
	return false
}

// IsServerError returns true when this handle internal server error response has a 5xx status code
func (o *HandleInternalServerError) IsServerError() bool {
	return true
}

// IsCode returns true when this handle internal server error response a status code equal to that given
func (o *HandleInternalServerError) IsCode(code int) bool {
	return code == 500
}

// Code gets the status code for the handle internal server error response
func (o *HandleInternalServerError) Code() int {
	return 500
}

func (o *HandleInternalServerError) Error() string {
	return fmt.Sprintf("[POST /data-security-dspm/entities/kafka-rest-produce/v1][%d] handleInternalServerError  %+v", 500, o.Payload)
}

func (o *HandleInternalServerError) String() string {
	return fmt.Sprintf("[POST /data-security-dspm/entities/kafka-rest-produce/v1][%d] handleInternalServerError  %+v", 500, o.Payload)
}

func (o *HandleInternalServerError) GetPayload() *models.MsaReplyMetaOnly {
	return o.Payload
}

func (o *HandleInternalServerError) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
