...
func (o *GetIntegrationsV3OK) Error() string {
	...
	return fmt.Sprintf("[GET /saas-security/entities/integrations/v3][%d] getIntegrationsV3OK %s", 200, payload)
}
...
func (o *GetIntegrationsV3Forbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /saas-security/entities/integrations/v3][%d] getIntegrationsV3Forbidden %s", 403, payload)
}
...
func (o *GetIntegrationsV3TooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /saas-security/entities/integrations/v3][%d] getIntegrationsV3TooManyRequests %s", 429, payload)
}
...
func (o *GetIntegrationsV3InternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /saas-security/entities/integrations/v3][%d] getIntegrationsV3InternalServerError %s", 500, payload)
}
