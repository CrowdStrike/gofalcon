...
// New creates a new container vulnerabilities API client with basic auth credentials.
...
// New creates a new container vulnerabilities API client with a bearer token for authentication.
// It takes the following parameters:
// - host: http host (github.com).
// - basePath: any base path for the API client ("/v1", "/v3").
// - scheme: http scheme ("http", "https").
...
/*
ReadCombinedVulnerabilities retrieves a paginated list of vulnerabilities filtered by the provided f q l maximum page size 100 maximum available vulnerabilities 10 000
*/
