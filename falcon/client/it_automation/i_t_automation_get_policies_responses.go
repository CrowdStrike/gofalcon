...
func (o *ITAutomationGetPoliciesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
...
func (o *ITAutomationGetPoliciesOK) Error() string {
	return fmt.Sprintf("[GET /it-automation/entities/policies/v1][%d] iTAutomationGetPoliciesOK  %+v", 200, o.Payload)
}
...
func (o *ITAutomationGetPoliciesBadRequest) Error() string {
	return fmt.Sprintf("[GET /it-automation/entities/policies/v1][%d] iTAutomationGetPoliciesBadRequest  %+v", 400, o.Payload)
}
...
func (o *ITAutomationGetPoliciesForbidden) Error() string {
	return fmt.Sprintf("[GET /it-automation/entities/policies/v1][%d] iTAutomationGetPoliciesForbidden  %+v", 403, o.Payload)
}
...
func (o *ITAutomationGetPoliciesTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /it-automation/entities/policies/v1][%d] iTAutomationGetPoliciesTooManyRequests  %+v", 429, o.Payload)
}
...
func (o *ITAutomationGetPoliciesInternalServerError) Error() string {
	return fmt.Sprintf("[GET /it-automation/entities/policies/v1][%d] iTAutomationGetPoliciesInternalServerError  %+v", 500, o.Payload)
}
