...
func (o *ITAutomationUpdateTaskReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewITAutomationUpdateTaskBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *ITAutomationUpdateTaskOK) Error() string {
	...
	return fmt.Sprintf("[PATCH /it-automation/entities/tasks/v1][%d] iTAutomationUpdateTaskOK %s", 200, payload)
}
...
// NewITAutomationUpdateTaskBadRequest creates a ITAutomationUpdateTaskBadRequest with default headers values
func NewITAutomationUpdateTaskBadRequest() *ITAutomationUpdateTaskBadRequest {
	return &ITAutomationUpdateTaskBadRequest{}
}

/*
ITAutomationUpdateTaskBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type ITAutomationUpdateTaskBadRequest struct {
...
// IsSuccess returns true when this i t automation update task bad request response has a 2xx status code
func (o *ITAutomationUpdateTaskBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this i t automation update task bad request response has a 3xx status code
func (o *ITAutomationUpdateTaskBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this i t automation update task bad request response has a 4xx status code
func (o *ITAutomationUpdateTaskBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this i t automation update task bad request response has a 5xx status code
func (o *ITAutomationUpdateTaskBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this i t automation update task bad request response a status code equal to that given
func (o *ITAutomationUpdateTaskBadRequest) IsCode(code int) bool {
	return code == 400
}

// Code gets the status code for the i t automation update task bad request response
func (o *ITAutomationUpdateTaskBadRequest) Code() int {
	return 400
}

func (o *ITAutomationUpdateTaskBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /it-automation/entities/tasks/v1][%d] iTAutomationUpdateTaskBadRequest %s", 400, payload)
}

func (o *ITAutomationUpdateTaskBadRequest) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /it-automation/entities/tasks/v1][%d] iTAutomationUpdateTaskBadRequest %s", 400, payload)
}

func (o *ITAutomationUpdateTaskBadRequest) GetPayload() *models.MsaspecResponseFields {
	return o.Payload
}

func (o *ITAutomationUpdateTaskBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *ITAutomationUpdateTaskForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /it-automation/entities/tasks/v1][%d] iTAutomationUpdateTaskForbidden %s", 403, payload)
}
...
func (o *ITAutomationUpdateTaskTooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /it-automation/entities/tasks/v1][%d] iTAutomationUpdateTaskTooManyRequests %s", 429, payload)
}
...
func (o *ITAutomationUpdateTaskInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /it-automation/entities/tasks/v1][%d] iTAutomationUpdateTaskInternalServerError %s", 500, payload)
}
