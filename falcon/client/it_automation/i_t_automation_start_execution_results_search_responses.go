...
func (o *ITAutomationStartExecutionResultsSearchReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 201:
		...
		return result, nil
	case 400:
		result := NewITAutomationStartExecutionResultsSearchBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewITAutomationStartExecutionResultsSearchBadRequest creates a ITAutomationStartExecutionResultsSearchBadRequest with default headers values
func NewITAutomationStartExecutionResultsSearchBadRequest() *ITAutomationStartExecutionResultsSearchBadRequest {
	return &ITAutomationStartExecutionResultsSearchBadRequest{}
}

/*
ITAutomationStartExecutionResultsSearchBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type ITAutomationStartExecutionResultsSearchBadRequest struct {
...
// IsSuccess returns true when this i t automation start execution results search bad request response has a 2xx status code
func (o *ITAutomationStartExecutionResultsSearchBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this i t automation start execution results search bad request response has a 3xx status code
func (o *ITAutomationStartExecutionResultsSearchBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this i t automation start execution results search bad request response has a 4xx status code
func (o *ITAutomationStartExecutionResultsSearchBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this i t automation start execution results search bad request response has a 5xx status code
func (o *ITAutomationStartExecutionResultsSearchBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this i t automation start execution results search bad request response a status code equal to that given
func (o *ITAutomationStartExecutionResultsSearchBadRequest) IsCode(code int) bool {
	return code == 400
}

// Code gets the status code for the i t automation start execution results search bad request response
func (o *ITAutomationStartExecutionResultsSearchBadRequest) Code() int {
	return 400
}
...
func (o *ITAutomationStartExecutionResultsSearchBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
