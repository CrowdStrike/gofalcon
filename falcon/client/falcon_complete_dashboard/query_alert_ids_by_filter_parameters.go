...
// NewQueryAlertIdsByFilterParams creates a new QueryAlertIdsByFilterParams object,
...
func NewQueryAlertIdsByFilterParams() *QueryAlertIdsByFilterParams {
	return &QueryAlertIdsByFilterParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewQueryAlertIdsByFilterParamsWithTimeout creates a new QueryAlertIdsByFilterParams object
...
// NewQueryAlertIdsByFilterParamsWithContext creates a new QueryAlertIdsByFilterParams object
...
// NewQueryAlertIdsByFilterParamsWithHTTPClient creates a new QueryAlertIdsByFilterParams object
...
func (o *QueryAlertIdsByFilterParams) WithDefaults() *QueryAlertIdsByFilterParams {
	o.SetDefaults()
	return o
}
...
func (o *QueryAlertIdsByFilterParams) WithTimeout(timeout time.Duration) *QueryAlertIdsByFilterParams {
...
func (o *QueryAlertIdsByFilterParams) WithContext(ctx context.Context) *QueryAlertIdsByFilterParams {
	o.SetContext(ctx)
	return o
}
...
func (o *QueryAlertIdsByFilterParams) WithHTTPClient(client *http.Client) *QueryAlertIdsByFilterParams {
...
func (o *QueryAlertIdsByFilterParams) WithFilter(filter *string) *QueryAlertIdsByFilterParams {
	o.SetFilter(filter)
	return o
}
...
func (o *QueryAlertIdsByFilterParams) WithLimit(limit *int64) *QueryAlertIdsByFilterParams {
	o.SetLimit(limit)
	return o
}
...
func (o *QueryAlertIdsByFilterParams) WithOffset(offset *string) *QueryAlertIdsByFilterParams {
	o.SetOffset(offset)
	return o
}
...
func (o *QueryAlertIdsByFilterParams) WithSort(sort *string) *QueryAlertIdsByFilterParams {
	o.SetSort(sort)
	return o
}
...
func (o *QueryAlertIdsByFilterParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
