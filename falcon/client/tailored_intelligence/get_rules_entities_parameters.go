...
// WithAuthorization adds the authorization to the get rules entities params
func (o *GetRulesEntitiesParams) WithAuthorization(authorization *string) *GetRulesEntitiesParams {
	o.SetAuthorization(authorization)
	return o
}

// SetAuthorization adds the authorization to the get rules entities params
func (o *GetRulesEntitiesParams) SetAuthorization(authorization *string) {
