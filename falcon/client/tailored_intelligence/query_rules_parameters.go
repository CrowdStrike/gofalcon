...
// WithAuthorization adds the authorization to the query rules params
func (o *QueryRulesParams) WithAuthorization(authorization *string) *QueryRulesParams {
	o.SetAuthorization(authorization)
	return o
}

// SetAuthorization adds the authorization to the query rules params
func (o *QueryRulesParams) SetAuthorization(authorization *string) {
