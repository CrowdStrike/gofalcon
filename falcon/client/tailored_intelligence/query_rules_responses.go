...
func (o *QueryRulesOK) Error() string {
	...
	return fmt.Sprintf("[GET /ti/rules/queries/rules/v2][%d] queryRulesOK %s", 200, payload)
}
...
func (o *QueryRulesBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /ti/rules/queries/rules/v2][%d] queryRulesBadRequest %s", 400, payload)
}
...
func (o *QueryRulesTooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /ti/rules/queries/rules/v2][%d] queryRulesTooManyRequests %s", 429, payload)
}
...
func (o *QueryRulesInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /ti/rules/queries/rules/v2][%d] queryRulesInternalServerError %s", 500, payload)
}
