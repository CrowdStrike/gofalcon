...
// WithAuthorization adds the authorization to the get events body params
func (o *GetEventsBodyParams) WithAuthorization(authorization *string) *GetEventsBodyParams {
	o.SetAuthorization(authorization)
	return o
}

// SetAuthorization adds the authorization to the get events body params
func (o *GetEventsBodyParams) SetAuthorization(authorization *string) {
