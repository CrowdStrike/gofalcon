...
// WithAuthorization adds the authorization to the get events entities params
func (o *GetEventsEntitiesParams) WithAuthorization(authorization *string) *GetEventsEntitiesParams {
	o.SetAuthorization(authorization)
	return o
}

// SetAuthorization adds the authorization to the get events entities params
func (o *GetEventsEntitiesParams) SetAuthorization(authorization *string) {
