...
func (o *ValidateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 429:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /loggingapi/entities/saved-searches-validate/v1] Validate", response, response.Code())
	}
}
...
func (o *ValidateOK) Error() string {
	return fmt.Sprintf("[POST /loggingapi/entities/saved-searches-validate/v1][%d] validateOK  %+v", 200, o.Payload)
}
...
func (o *ValidateForbidden) Error() string {
	return fmt.Sprintf("[POST /loggingapi/entities/saved-searches-validate/v1][%d] validateForbidden  %+v", 403, o.Payload)
}
...
func (o *ValidateTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /loggingapi/entities/saved-searches-validate/v1][%d] validateTooManyRequests  %+v", 429, o.Payload)
}
