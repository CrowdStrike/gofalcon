...
func (o *QueryByIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 429:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /loggingapi/entities/saved-searches/v1] QueryById", response, response.Code())
	}
}
...
func (o *QueryByIDOK) Error() string {
	return fmt.Sprintf("[GET /loggingapi/entities/saved-searches/v1][%d] queryByIdOK  %+v", 200, o.Payload)
}
...
func (o *QueryByIDForbidden) Error() string {
	return fmt.Sprintf("[GET /loggingapi/entities/saved-searches/v1][%d] queryByIdForbidden  %+v", 403, o.Payload)
}
...
func (o *QueryByIDTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /loggingapi/entities/saved-searches/v1][%d] queryByIdTooManyRequests  %+v", 429, o.Payload)
}
