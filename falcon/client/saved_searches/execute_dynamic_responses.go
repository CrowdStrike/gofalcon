...
func (o *ExecuteDynamicReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 429:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /loggingapi/entities/saved-searches-dynamic-execute/v1] ExecuteDynamic", response, response.Code())
	}
}
...
func (o *ExecuteDynamicOK) Error() string {
	return fmt.Sprintf("[POST /loggingapi/entities/saved-searches-dynamic-execute/v1][%d] executeDynamicOK  %+v", 200, o.Payload)
}
...
func (o *ExecuteDynamicForbidden) Error() string {
	return fmt.Sprintf("[POST /loggingapi/entities/saved-searches-dynamic-execute/v1][%d] executeDynamicForbidden  %+v", 403, o.Payload)
}
...
func (o *ExecuteDynamicTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /loggingapi/entities/saved-searches-dynamic-execute/v1][%d] executeDynamicTooManyRequests  %+v", 429, o.Payload)
}
