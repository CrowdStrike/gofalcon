...
func (o *QueryReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 429:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /loggingapi/queries/saved-searches/v1] Query", response, response.Code())
	}
}
...
func (o *QueryOK) Error() string {
	return fmt.Sprintf("[GET /loggingapi/queries/saved-searches/v1][%d] queryOK  %+v", 200, o.Payload)
}
...
func (o *QueryForbidden) Error() string {
	return fmt.Sprintf("[GET /loggingapi/queries/saved-searches/v1][%d] queryForbidden  %+v", 403, o.Payload)
}
...
func (o *QueryTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /loggingapi/queries/saved-searches/v1][%d] queryTooManyRequests  %+v", 429, o.Payload)
}
