...
func (o *CreateFileV1OK) Error() string {
	...
	return fmt.Sprintf("[POST /loggingapi/entities/lookup-files/v1][%d] createFileV1OK %s", 200, payload)
}
...
func (o *CreateFileV1BadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /loggingapi/entities/lookup-files/v1][%d] createFileV1BadRequest %s", 400, payload)
}
...
func (o *CreateFileV1Forbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /loggingapi/entities/lookup-files/v1][%d] createFileV1Forbidden %s", 403, payload)
}
...
func (o *CreateFileV1NotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /loggingapi/entities/lookup-files/v1][%d] createFileV1NotFound %s", 404, payload)
}
...
func (o *CreateFileV1TooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /loggingapi/entities/lookup-files/v1][%d] createFileV1TooManyRequests %s", 429, payload)
}
...
func (o *CreateFileV1InternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /loggingapi/entities/lookup-files/v1][%d] createFileV1InternalServerError %s", 500, payload)
}
