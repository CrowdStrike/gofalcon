...
func (o *GetScansReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /netscan/entities/scans/v1] get-scans", response, response.Code())
	}
}
...
func (o *GetScansOK) Error() string {
	return fmt.Sprintf("[GET /netscan/entities/scans/v1][%d] getScansOK  %+v", 200, o.Payload)
}
...
func (o *GetScansOK) GetPayload() *models.DomainScanEntitiesResponse {
	return o.Payload
}
...
func (o *GetScansBadRequest) Error() string {
	return fmt.Sprintf("[GET /netscan/entities/scans/v1][%d] getScansBadRequest  %+v", 400, o.Payload)
}
...
func (o *GetScansBadRequest) GetPayload() *models.MsaspecResponseFields {
	return o.Payload
}
...
func (o *GetScansForbidden) Error() string {
	return fmt.Sprintf("[GET /netscan/entities/scans/v1][%d] getScansForbidden  %+v", 403, o.Payload)
}
...
func (o *GetScansForbidden) GetPayload() *models.MsaspecResponseFields {
	return o.Payload
}
...
func (o *GetScansNotFound) Error() string {
	return fmt.Sprintf("[GET /netscan/entities/scans/v1][%d] getScansNotFound  %+v", 404, o.Payload)
}
...
func (o *GetScansNotFound) GetPayload() *models.MsaspecResponseFields {
	return o.Payload
}
...
func (o *GetScansTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /netscan/entities/scans/v1][%d] getScansTooManyRequests  %+v", 429, o.Payload)
}
...
func (o *GetScansInternalServerError) Error() string {
	return fmt.Sprintf("[GET /netscan/entities/scans/v1][%d] getScansInternalServerError  %+v", 500, o.Payload)
}
...
func (o *GetScansInternalServerError) GetPayload() *models.MsaspecResponseFields {
	return o.Payload
}
