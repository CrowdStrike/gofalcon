...
func (o *FdrschemaCombinedEventGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 429:
		...
		return nil, result
	case 500:
		result := NewFdrschemaCombinedEventGetInternalServerError()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewFdrschemaCombinedEventGetInternalServerError creates a FdrschemaCombinedEventGetInternalServerError with default headers values
func NewFdrschemaCombinedEventGetInternalServerError() *FdrschemaCombinedEventGetInternalServerError {
	return &FdrschemaCombinedEventGetInternalServerError{}
}

/*
FdrschemaCombinedEventGetInternalServerError describes a response with status code 500, with default header values.

Unexpected Error
*/
type FdrschemaCombinedEventGetInternalServerError struct {
...
// IsSuccess returns true when this fdrschema combined event get internal server error response has a 2xx status code
func (o *FdrschemaCombinedEventGetInternalServerError) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this fdrschema combined event get internal server error response has a 3xx status code
func (o *FdrschemaCombinedEventGetInternalServerError) IsRedirect() bool {
	return false
}

// IsClientError returns true when this fdrschema combined event get internal server error response has a 4xx status code
func (o *FdrschemaCombinedEventGetInternalServerError) IsClientError() bool {
	return false
}

// IsServerError returns true when this fdrschema combined event get internal server error response has a 5xx status code
func (o *FdrschemaCombinedEventGetInternalServerError) IsServerError() bool {
	return true
}

// IsCode returns true when this fdrschema combined event get internal server error response a status code equal to that given
func (o *FdrschemaCombinedEventGetInternalServerError) IsCode(code int) bool {
	return code == 500
}

// Code gets the status code for the fdrschema combined event get internal server error response
func (o *FdrschemaCombinedEventGetInternalServerError) Code() int {
	return 500
}
...
func (o *FdrschemaCombinedEventGetInternalServerError) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
