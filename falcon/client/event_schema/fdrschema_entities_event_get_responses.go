...
func (o *FdrschemaEntitiesEventGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 429:
		...
		return nil, result
	case 500:
		result := NewFdrschemaEntitiesEventGetInternalServerError()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *FdrschemaEntitiesEventGetOK) Error() string {
	...
	return fmt.Sprintf("[GET /fdr/entities/schema-events/v1][%d] fdrschemaEntitiesEventGetOK %s", 200, payload)
}
...
func (o *FdrschemaEntitiesEventGetForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /fdr/entities/schema-events/v1][%d] fdrschemaEntitiesEventGetForbidden %s", 403, payload)
}
...
func (o *FdrschemaEntitiesEventGetTooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /fdr/entities/schema-events/v1][%d] fdrschemaEntitiesEventGetTooManyRequests %s", 429, payload)
}
...
// NewFdrschemaEntitiesEventGetInternalServerError creates a FdrschemaEntitiesEventGetInternalServerError with default headers values
func NewFdrschemaEntitiesEventGetInternalServerError() *FdrschemaEntitiesEventGetInternalServerError {
	return &FdrschemaEntitiesEventGetInternalServerError{}
}

/*
FdrschemaEntitiesEventGetInternalServerError describes a response with status code 500, with default header values.

Unexpected Error
*/
type FdrschemaEntitiesEventGetInternalServerError struct {
...
// IsSuccess returns true when this fdrschema entities event get internal server error response has a 2xx status code
func (o *FdrschemaEntitiesEventGetInternalServerError) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this fdrschema entities event get internal server error response has a 3xx status code
func (o *FdrschemaEntitiesEventGetInternalServerError) IsRedirect() bool {
	return false
}

// IsClientError returns true when this fdrschema entities event get internal server error response has a 4xx status code
func (o *FdrschemaEntitiesEventGetInternalServerError) IsClientError() bool {
	return false
}

// IsServerError returns true when this fdrschema entities event get internal server error response has a 5xx status code
func (o *FdrschemaEntitiesEventGetInternalServerError) IsServerError() bool {
	return true
}

// IsCode returns true when this fdrschema entities event get internal server error response a status code equal to that given
func (o *FdrschemaEntitiesEventGetInternalServerError) IsCode(code int) bool {
	return code == 500
}

// Code gets the status code for the fdrschema entities event get internal server error response
func (o *FdrschemaEntitiesEventGetInternalServerError) Code() int {
	return 500
}

func (o *FdrschemaEntitiesEventGetInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /fdr/entities/schema-events/v1][%d] fdrschemaEntitiesEventGetInternalServerError %s", 500, payload)
}

func (o *FdrschemaEntitiesEventGetInternalServerError) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /fdr/entities/schema-events/v1][%d] fdrschemaEntitiesEventGetInternalServerError %s", 500, payload)
}

func (o *FdrschemaEntitiesEventGetInternalServerError) GetPayload() *models.MsaReplyMetaOnly {
	return o.Payload
}

func (o *FdrschemaEntitiesEventGetInternalServerError) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
