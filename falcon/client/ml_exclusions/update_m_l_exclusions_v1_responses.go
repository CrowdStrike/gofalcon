...
func (o *UpdateMLExclusionsV1OK) Error() string {
	...
	return fmt.Sprintf("[PATCH /policy/entities/ml-exclusions/v1][%d] updateMLExclusionsV1OK %s", 200, payload)
}
...
func (o *UpdateMLExclusionsV1BadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /policy/entities/ml-exclusions/v1][%d] updateMLExclusionsV1BadRequest %s", 400, payload)
}
...
func (o *UpdateMLExclusionsV1Forbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /policy/entities/ml-exclusions/v1][%d] updateMLExclusionsV1Forbidden %s", 403, payload)
}
...
func (o *UpdateMLExclusionsV1TooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /policy/entities/ml-exclusions/v1][%d] updateMLExclusionsV1TooManyRequests %s", 429, payload)
}
...
func (o *UpdateMLExclusionsV1InternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /policy/entities/ml-exclusions/v1][%d] updateMLExclusionsV1InternalServerError %s", 500, payload)
}
